...
class Admin extends react_1.default.Component {
    constructor() {
         ...
         * @param {*} level
         */
        this.updateWorkshopLevel = (workshopID, level) => {
            this.props.database
                .firestore()
                .collection("StudentsAtWorkshop")
                .doc(workshopID)
         ...
         * @param {*} status
         */
        this.updateWorkshopStatus = (workshopID, status) => {
         ...
         * @param {*} workshopID
         */
        this.clearStudentsAtWorkshop = (workshopID) => {
            this.props.database
                .firestore()
                .collection("StudentsAtWorkshop")
                .doc(workshopID)
         ...
         */
        this.updateWorkshop = (workshopID, workshopObject) => {
            this.props.database
                .firestore()
                .collection("Workshop")
                .doc(workshopID)
         ...
         * @param {*} workshopObject
         */
        this.createNewWorkshop = (workshopObject) => {
            ...
            this.props.database
                ...
                console.log(error + " error occured in adding empty sudents at workshop object");
            });
     ...
     */
    render() {
        return (react_1.default.createElement("div", null, this.state.loggedIn ? (react_1.default.createElement(AdminDashboard_1.default, { workshop_data: this.state.workshop_data, student_data: this.state.student_data, readStudentData: this.readStudentData, readWorkshopData: this.readWorkshopData, updateWorkshop: this.updateWorkshop, updateLevel: this.updateWorkshopLevel, createWorkshop: this.createNewWorkshop, deleteWorkshop: this.deleteWorkshop, updateStatus: this.updateWorkshopStatus, clearWorkshop: this.clearStudentsAtWorkshop, progressListener: this.progressListener, workshopListener: this.workshopListener, signOut: this.signOutUser, dataLoaded: this.state.workshop_data && this.state.student_data, alert: this.state.alert, alertText: this.state.alertText, resetAlertStatus: this.resetAlertStatus })) : (react_1.default.createElement(AdminAuth_1.default, { authenticate: this.authenticate, loginError: this.state.loginError }))));
    }
}

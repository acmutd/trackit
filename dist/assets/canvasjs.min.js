...
/*jshint ignore:start*/
(function () {
    function qa(p, m) { p.prototype = eb(m.prototype); p.prototype.constructor = p; p.base = m.prototype; }
    function eb(p) { function m() { } m.prototype = p; return new m; }
    function Ya(p, m, D) {
    ...
    function $(p, m) { var D = !1; 0 > p && (D = !0, p *= -1); p = "" + p; for (m = m ? m : 1; p.length < m;)
        p = "0" + p; return D ? "-" + p : p; }
    function Ia(p) { if (!p)
        return p; p = p.replace(/^\s\s*/, ""); for (var m = /\s/, D = p.length; m.test(p.charAt(--D));)
    ...
    function Sa(p, m) { return p - m; }
    function Ta(p, m, D) {
        if (p && m && D) {
            D = D + "." + m;
            var r = "image/" + m;
            p = p.toDataURL(r);
            var v = !1, F = document.createElement("a");
            F.download = D;
            F.href = p;
            if ("undefined" !== typeof Blob && new Blob) {
                for (var H = p.replace(/^data:[a-z\/]*;base64,/, ""), H = atob(H), y = new ArrayBuffer(H.length), y = new Uint8Array(y), w = 0; w < H.length; w++)
                    y[w] = H.charCodeAt(w);
                m = new Blob([y.buffer], { type: "image/" + m });
                try {
    ...
    function N(p) { var m = ((p & 16711680) >> 16).toString(16), D = ((p & 65280) >> 8).toString(16); p = ((p & 255) >> 0).toString(16); m = 2 > m.length ? "0" + m : m; D = 2 > D.length ? "0" + D : D; p = 2 > p.length ? "0" + p : p; return "#" + m + D + p; }
    function fb(p, m) { var D = this.length >>> 0, r = Number(m) || 0, r = 0 > r ? Math.ceil(r) : Math.floor(r); for (0 > r && (r += D); r < D; r++)
        if (r in this && this[r] === p)
            return r; return -1; }
    function v(p) { return null === p || "undefined" === typeof p; }
    function Fa(p) { p.indexOf || (p.indexOf = fb); return p; }
    function gb(p) {
        if (U.fSDec)
            p[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { U._fTWm && U._fTWm(p); });
    }
    function Za(p, m, D) {
        D = D || "normal";
        var r = p + "_" + m + "_" + D, v = $a[r];
        if (isNaN(v)) {
            try {
    ...
    function R(p, m) { var D = []; if (D = { solid: [], shortDash: [3, 1], shortDot: [1, 1], shortDashDot: [3, 1, 1, 1], shortDashDotDot: [3, 1, 1, 1, 1, 1], dot: [1, 2], dash: [4, 2], dashDot: [4, 2, 1, 2], longDash: [8, 2], longDashDot: [8, 2, 1, 2], longDashDotDot: [8, 2, 1, 2, 1, 2] }[p || "solid"])
    ...
    function O(p, m, D, r, v) {
        ...
        return p.addEventListener ? (p.addEventListener(m, D, v), D) : p.attachEvent ?
            (r = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1; }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0; }; D.call(p, m); }, p.attachEvent("on" + m, r), r) : !1;
    }
    function ab(p, m, D) { p *= W; m *= W; p = D.getImageData(p, m, 2, 2).data; m = !0; for (D = 0; 4 > D; D++)
        if (p[D] !== p[D + 4] | p[D] !== p[D + 8] | p[D] !== p[D + 12]) {
            m = !1;
            break;
        } return m ? p[0] << 16 | p[1] << 8 | p[2] : 0; }
    function na(p, m, D) { return p in m ? m[p] : D[p]; }
    function Oa(p, m, D) {
        if (r && bb) {
    ...
    function hb(p) {
        if (!ib) {
            ...
            if (p.creditHref && p.creditText) {
                ...
                if (0 === p.renderCount ||
                    m || D)
                    p._creditLink.setAttribute("href", p.creditHref), p._creditLink.innerHTML = p.creditText;
    ...
    function sa(p, m, D) { for (var r in D)
        m.style[r] = D[r]; }
    function ua(p, m, D) {
        m.getAttribute("state") || (m.style.backgroundColor = p.toolbar.backgroundColor, m.style.color = p.toolbar.fontColor, m.style.border = "none", sa(p, m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        m.getAttribute("state") !== D && (m.setAttribute("state", D), m.setAttribute("type", "button"), sa(p, m, { padding: "5px 12px",
            cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), m.setAttribute("title", p._cultureInfo[D + "Text"]), m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[D].image + "' alt='" + p._cultureInfo[D + "Text"] + "' />");
    }
    function Qa() { for (var p = null, m = 0; m < arguments.length; m++)
        p = arguments[m], p.style && (p.style.display = "inline"); }
    function va() { for (var p = null, m = 0; m < arguments.length; m++)
        (p = arguments[m]) && p.style && (p.style.display = "none"); }
    ...
    function Ga(p, m, r, v, w) { "undefined" === typeof w && (w = 0); this._padding = w; this._x1 = p; this._y1 = m; this._x2 = r; this._y2 = v; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding; }
    function ka(p, m) { ka.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = p; this._isDirty = !0; this._wrappedText = null; this._initialize(); }
    function Va(p, m) {
    ...
    function La(p) { var m; p && Ma[p] && (m = Ma[p]); La.base.constructor.call(this, "CultureInfo", null, m, null, null); }
    ...
    var X = 20, E = 14, Xa = { colorSet: "colorSet1",
        backgroundColor: "#FFFFFF", title: { fontFamily: Ha, fontSize: 32, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ha, fontSize: E, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: fa, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{ titleFontFamily: w, titleFontSize: X, titleFontColor: fa, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: Q, labelFontWeight: "normal",
            ...
            horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 } };
    Q = fa = "#F5F5F5";
    I = "#FFFFFF";
    ha = "#40BAF1";
    ga = "#F5F5F5";
    ...
    (function () {
        U.fSDec = function (p) { for (var m = "", r = 0; r < p.length; r++)
            m += String.fromCharCode(p[r] - 111); return m; };
        U.str = { ncv: [189, 222, 221, 156, 178, 222, 220, 220, 212, 225, 210, 216, 208, 219, 143, 197, 212, 225, 226, 216, 222, 221], fntStr: [223, 231, 143, 178, 208, 219, 216, 209, 225, 216,
        ...
        delete ra[U.fSDec([178, 215, 208, 225, 227])][U.fSDec([210, 225, 212, 211, 216,
            227, 183, 225, 212, 213])];
        U.pro = { sCH: ra[U.fSDec([178, 215, 208, 225, 227])][U.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])] };
        U._fTWm = function (p) { if ("undefined" === typeof U.pro.sCH && !db) {
    ...
    var $a = {}, xa = null, kb = function () {
    ...
    }, lb = function (p, m, r) { m = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= m ? 12 : 10, Math.round(m * (p / 400))); }, Ca = function () {
        var p = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), r = "Sun Mon Tue Wed Thu Fri Sat".split(" "), v = "January February March April May June July August September October November December".split(" "), w = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), F = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, H = /[^-+\dA-Z]/g;
        return function (y, E, L) {
            var R = L ? L.days : m, I = L ? L.months : v, N = L ? L.shortDays : r, O = L ? L.shortMonths : w;
            L = "";
            var S = !1;
            ...
            L = S ? "getUTC" : "get";
            var U = y[L + "Date"](), V = y[L + "Day"](), M = y[L + "Month"](), Q = y[L + "FullYear"](), a = y[L + "Hours"](), d = y[L + "Minutes"](), b = y[L + "Seconds"](), c = y[L + "Milliseconds"](), e = S ? 0 : y.getTimezoneOffset();
            return L = E.replace(p, function (g) {
                switch (g) {
                    ...
                    case "T": return 12 > a ? "A" : "P";
                    case "TT": return 12 > a ? "AM" : "PM";
                    case "K": return S ? "UTC" : (String(y).match(F) || [""]).pop().replace(H, "");
        ...
        var v = 0 > p ? !0 : !1;
        v && (p *= -1);
        var w = r ? r.decimalSeparator : ".", F = r ? r.digitGroupSeparator : ",", H = "";
        m = String(m);
        var H = 1, y = r = "", E = -1, L = [], R = [], I = 0, N = 0, S = 0, O = !1, U = 0, y = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        m = null;
        for (var Q = 0; y && Q < y.length; Q++)
            if (m = y[Q], "." === m && 0 > E)
                ...
                if ("%" === m)
                    ...
                    "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (O = !0);
        ...
        for (O = y = Q = N = E = 0; 0 < L.length;)
            if (m = L.pop(), "#" === m || "0" === m)
                if (E++, E === I) {
                    var M = H, H = [];
                    if ("0" === m)
                        for (m = I - N - (M ? M.length : 0); 0 < m;)
                            M.unshift("0"), m--;
                    for (; 0 < M.length;)
                        r = M.pop() + r, O++, 0 === O % y && (Q === S && 0 < M.length) && (r = F + r);
                }
                else
                    0 < H.length ? (r = H.pop() + r, N++, O++) : "0" === m && (r = "0" + r, N++, O++), 0 === O % y && (Q === S && 0 < H.length) && (r = F + r);
            else
                "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (Q++, y = O, O = 0, 0 < H.length &&
                    (r = F + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > U ? m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function (p) { return $(U, p.length); }));
        F = "";
        for (L = !1; 0 < R.length;)
            m = R.shift(), "#" === m || "0" === m ? 0 < p.length && 0 !== Number(p.join("")) ? (F += p.shift(), L = !0) : "0" === m && (F += "0", L = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? F += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length -
                1] || !/[eE][+-]*[0]+/.test(m) ? F += m : (m = 0 > U ? m.replace("+", "").replace("-", "") : m.replace("-", ""), F += m.replace(/[0]+/, function (p) { return $(U, p.length); }));
        r += (L ? w : "") + F;
        return v ? "-" + r : r;
    }, Ra = function (p) { var m = 0, r = 0; p = p || window.event; p.offsetX || 0 === p.offsetX ? (m = p.offsetX, r = p.offsetY) : p.layerX || 0 == p.layerX ? (m = p.layerX, r = p.layerY) : (m = p.pageX - p.target.offsetLeft, r = p.pageY - p.target.offsetTop); return { x: m, y: r }; }, bb = !0, Ua = window.devicePixelRatio || 1, Pa = 1, W = bb ? Ua / Pa : 1, ea = function (p, m, r, v, w, F, H, y, E, L, R, N, O) {
        "undefined" ===
            typeof O && (O = 1);
        H = H || 0;
        y = y || "black";
        ...
        !0 === R && (p.save(), p.beginPath(), p.moveTo(m, r), p.lineTo(m + I, r + I), p.lineTo(m + I, w - I), p.lineTo(m, w), p.closePath(), H = p.createLinearGradient(m + I, (w + r) / 2, m, (w + r) / 2), H.addColorStop(0, F), H.addColorStop(1, "rgba(255, 255, 255, 0.1)"), p.fillStyle = H, p.fill(), p.restore());
    ...
    V.prototype.get = function (p) { var m = ra[this._defaultsKey]; if ("options" === p)
        return this.options && this.options._isPlaceholder ? null : this.options; if (m.hasOwnProperty(p) || m.publicProperties && m.publicProperties.hasOwnProperty(p))
        return this[p]; window.console && window.console.log('Property "' + p + "\" doesn't exist. Please check for typo."); };
    V.prototype.set = function (p, m, r) {
        ...
        else if (v.hasOwnProperty(p) || v.publicProperties && v.publicProperties.hasOwnProperty(p) && "readWrite" === v.publicProperties[p])
            this.options._isPlaceholder && this.createUserOptions(), this.options[p] = m;
        else {
    ...
    V.prototype.createUserOptions = function (p) {
        if ("undefined" !== typeof p || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                this.options = "undefined" === typeof p ? {} : p, p = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (r = m.charAt(0).toLowerCase(), 1 < m.length && (r = r.concat(m.slice(1))), m = r) : m = void 0, p[m] = this.options;
    };
    ...
    V.prototype.updateOption = function (p) {
        ...
        var m = ra[this._defaultsKey], r = {}, w = this[p], E = this._themeOptionsKey, F = this._index;
    ...
    V.prototype.trackChanges = function (p) { if (!this.sessionVariables)
        throw "Session Variable Store not set"; this.sessionVariables[p] = this.options[p]; };
    V.prototype.isBeingTracked = function (p) {
        this.options._oldOptions ||
            (this.options._oldOptions = {});
        return this.options._oldOptions[p] ? !0 : !1;
    };
    V.prototype.hasOptionChanged = function (p) { if (!this.sessionVariables)
        throw "Session Variable Store not set"; return this.sessionVariables[p] !== this.options[p]; };
    V.prototype.addEventListener = function (p, m, r) { p && m && (this._eventListeners[p] = this._eventListeners[p] || [], this._eventListeners[p].push({ context: r || this, eventHandler: m })); };
    V.prototype.removeEventListener = function (p, m) {
        if (p && m && this._eventListeners[p])
            for (var r = this._eventListeners[p], v = 0; v < r.length; v++)
    ...
    V.prototype.dispatchEvent = function (p, m, r) { if (p && this._eventListeners[p]) {
        m = m || {};
        for (var v = this._eventListeners[p], w = 0; w < v.length; w++)
    ...
    Ga.prototype.unRegisterSpace = function (p, m) { "top" === p ? this._topOccupied -= m.height : "bottom" === p ? this._bottomOccupied -= m.height : "left" === p ? this._leftOccupied -= m.width : "right" === p && (this._rightOccupied -= m.width); };
    ...
    ka.prototype.render = function (p) {
        if (0 !== this.fontSize) {
            ...
            var v = 0, w = this.topPadding, F = null;
            ...
            for (r = 0; r < this._wrappedText.lines.length; r++)
                F = this._wrappedText.lines[r], "right" === this.horizontalAlign ? v = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding : "left" === this.horizontalAlign ? v =
    ...
    ka.prototype.setText = function (p) { this.text = p; this._isDirty = !0; this._wrappedText = null; };
    ...
    ka.prototype._getLineWithWidth = function (p, m, r) {
        ...
        if (!p)
            return { text: "", width: 0 };
        var v = r = 0, w = p.length - 1, F = Infinity;
        for (this.ctx.font = this._getFontString(); v <= w;) {
            var F = Math.floor((v + w) / 2), H = p.substr(0, F + 1);
        ...
        m = !0;
        if (H.length === p.length || " " === p[H.length])
            m = !1;
        m && (p = H.split(" "), 1 < p.length &&
            p.pop(), H = p.join(" "), r = this.ctx.measureText(H).width);
        return { text: H, width: r };
    };
    ka.prototype._wrapText = function () {
        var p = new String(Ia(String(this.text))), m = [], r = this.ctx.font, v = 0, w = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize)
            w = v = 0;
        else
            for (; 0 < p.length;) {
                var F = this.maxHeight - (this.topPadding + this.bottomPadding), H = this._getLineWithWidth(p, this.maxWidth - (this.leftPadding + this.rightPadding), !1);
                H.height = this._lineHeight;
                m.push(H);
                var y = w, w = Math.max(w, H.width), v = v + H.height, p = Ia(p.slice(H.text.length, p.length));
    ...
    ka.prototype._getFontString = function () { var p; p = "" + (this.fontStyle ? this.fontStyle + " " : ""); p += this.fontWeight ? this.fontWeight + " " : ""; p += this.fontSize ? this.fontSize + "px " : ""; var m = this.fontFamily ? this.fontFamily + "" : ""; !r && m && (m = m.split(",")[0], "'" !== m[0] && '"' !== m[0] && (m = "'" + m + "'")); return p += m; };
    qa(Va, V);
    qa(Aa, V);
    Aa.prototype.setLayout = function () {
        if (this.text) {
            var p = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = p.layoutManager.getFreeSpace(), r = m.x1, w = m.y1, E = 0, F = 0, H = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, y, I;
            ...
            F = new ka(this.ctx, { fontSize: this.fontSize, fontFamily: this.fontFamily, fontColor: this.fontColor, fontStyle: this.fontStyle, fontWeight: this.fontWeight, horizontalAlign: this.horizontalAlign, verticalAlign: this.verticalAlign, borderColor: this.borderColor, borderThickness: this.borderThickness, backgroundColor: this.backgroundColor, maxWidth: this.maxWidth, maxHeight: F, cornerRadius: this.cornerRadius, text: this.text, padding: this.padding, textBaseline: "top" });
            L = F.measureText();
            ...
            F.horizontalAlign = y;
            this._textBlock = F;
            p.layoutManager.registerSpace(I, { width: this.width + ("left" === I || "right" === I ? this.margin + 2 : 0),
                height: this.height + ("top" === I || "bottom" === I ? this.margin + 2 : 0) });
            this.bounds = { x1: r, y1: w, x2: r + this.width, y2: w + this.height };
    ...
    Wa.prototype.get = function (p, m) { var r = null; 0 < this.pool.length ? (r = this.pool.pop(), Oa(r, p, m)) : r = ta(p, m); return r; };
    Wa.prototype.release = function (p) { this.pool.push(p); };
    qa(La, V);
    var Na = { addTheme: function (p, m) { ya[p] = m; }, addColorSet: function (p, m) { Ba[p] = m; }, addCultureInfo: function (p, m) { Ma[p] = m; }, formatNumber: function (p, m, r) { r = r || "en"; if (Ma[r])
            return ba(p, m || "#,##0.##", new La(r)); throw "Unknown Culture Name"; }, formatDate: function (p, m, r) { r = r || "en"; if (Ma[r])
            return Ca(p, m || "DD MMM YYYY", new La(r)); throw "Unknown Culture Name"; } };
    ...
    Na.Chart = function () {
        ...
        function w(a, d) {
            for (var b = [], c, e = 0; e < a.length; e++)
                if (0 == e)
                    ...
                    var t = (a[h].x - a[g].x) / c;
                    c = (a[h].y - a[g].y) / c;
                    b[b.length] = a[k].x > a[g].x && 0 < t || a[k].x < a[g].x && 0 > t ? { x: a[k].x + t / 3, y: a[k].y + c / 3 } : { x: a[k].x, y: a[k].y + c / 9 };
                    k = e;
                    g = 0 === k ? 0 : k - 1;
                    h = k === a.length - 1 ? k : k + 1;
        ...
        function E(a, d, b, c, e, g, h, k, t, l) {
            ...
            var u = 1 === Math.round(h.thickness) % 2 ? 0.5 : 0, q = 1 === Math.round(k.thickness) % 2 ? 0.5 : 0;
            a.save();
            a.globalAlpha = l;
            ...
            if (this.options.data) {
                for (var b = 0; b < this.options.data.length; b++)
                    if (a++, !this.options.data[b].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[b].type)) {
                        ...
                        "bubble" !== c.type && "scatter" !== c.type || !c.dataPoints || (c.dataPoints.some ? c.dataPoints.some(function (a) { return a.x; }) && c.dataPoints.sort(p) : c.dataPoints.sort(p));
                        this.data.push(c);
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var b = 0; b < this.options.axisY.length; b++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new y(this, "axisY", this.options.axisY[b], b, "axisY", "left")) : "xySwapped" ===
                        ...
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (b = 0; b < this.options.axisY2.length; b++)
                                    "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new y(this, "axisY2", this.options.axisY2[b], b, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new y(this, "axisY2", this.options.axisY2[b], b, "axisY", "top"));
        ...
        m.prototype.renderElements = function () {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var g = this.plotInfo.plotTypes[d], h = 0; h < g.plotUnits.length; h++) {
                    ...
                    for (var l = 0; l < k.dataSeriesIndexes.length; l++)
                        this._dataInRenderedOrder.push(this.data[k.dataSeriesIndexes[l]]);
            ...
            var u = this;
            if (0 < b.length)
                u.disableToolTip = !0, u._animator.animate(200, u.animationDuration, function (a) {
                    ...
                    for (var e = 0; e < b.length; e++)
                        t = b[e], 1 > a && "undefined" !== typeof t.startTimePercent ? a >= t.startTimePercent && t.animationCallback(t.easingFunction(a - t.startTimePercent, 0, 1, 1 - t.startTimePercent), t) : t.animationCallback(t.easingFunction(a, 0, 1, 1), t);
                    u.dispatchEvent("dataAnimationIterationEnd", { chart: u });
                }, function () { b = []; for (var a = 0; a < u.plotInfo.plotTypes.length; a++)
                    for (var e = u.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++)
                        e.plotUnits[d].targetCanvas = null; c = null; u.disableToolTip = !1; });
            else {
                if (u._breaksCanvas)
                    if (r)
                        u.plotArea.ctx.drawImage(u._breaksCanvas, 0, 0, this.width, this.height);
                    else
                        for (l = 0; l < u._axes.length; l++)
                            u._axes[l].createMask();
            ...
            this.renderCount++;
            Ja && (u = this, setTimeout(function () { var a = document.getElementById("ghostCanvasCopy"); a && (Oa(a, u.width, u.height), a.getContext("2d").drawImage(u._eventManager.ghostCanvas, 0, 0)); }, 2E3));
            this._breaksCanvas && (delete this._breaksCanvas, delete this._breaksCanvasCtx);
            for (l = 0; l < this._axes.length; l++)
                this._axes[l].maskCanvas && (delete this._axes[l].maskCanvas,
                    delete this._axes[l].maskCtx);
        };
        m.prototype.render = function (a) { a && (this.options = a); this._initialize(); this.setLayout(); this.renderElements(); this._preRenderCanvas = null; };
        ...
        m.prototype._processMultiseriesPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var k = this.data[a.dataSeriesIndexes[h]], t = 0, l = !1, u = !1, q;
        ...
        m.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = [], k = [], t = Infinity, l = -Infinity, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var q = this.data[a.dataSeriesIndexes[u]], n = 0, f = !1, A = !1, p;
                ...
                for (n in h)
                    h.hasOwnProperty(n) && !isNaN(n) && (a = h[n], a < d.min && (d.min = Math.min(a, t)), a > d.max && (d.max = a), n < b.viewPortMin || n > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, t)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (n in k)
                    k.hasOwnProperty(n) && !isNaN(n) && (a = k[n], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, l)), n < b.viewPortMin || n > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax =
                        Math.max(a, l))));
            }
        };
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = !1, k = !1, t = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var u = this.data[a.dataSeriesIndexes[l]], q = 0, n = !1, f = !1, A;
                    ...
                    if (u.dataPoints[q].x && u.dataPoints[q].x.getTime || "dateTime" === u.xValueType)
                        g = !0;
                    for (q = 0; q < u.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            if (a.axisX.logarithmic) {
                                ...
                                s = c - u.dataPoints[q - 1].x, 0 > s && (s *= -1), b.minDiff > s && 0 !== s && (b.minDiff = s);
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, h, k = !1, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var l = this.data[a.dataSeriesIndexes[t]], u = 0, q = !1, n = !1, f, A, p;
                    if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
                        var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, s = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ?
                            this.options.axisX.maximum : Infinity;
                    if (l.dataPoints[u].x && l.dataPoints[u].x.getTime || "dateTime" === l.xValueType)
                        k = !0;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" ===
                ...
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var k = this.data[a.dataSeriesIndexes[h]], t = 0, l = !1, u = !1, q = c = 0;
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                    ...
                    if (k.dataPoints[t].x && k.dataPoints[t].x.getTime || "dateTime" === k.xValueType)
                        g = !0;
                    for (t = 0; t < k.dataPoints.length; t++)
                        "undefined" !== typeof k.dataPoints[t].isCumulativeSum && !0 === k.dataPoints[t].isCumulativeSum ?
                                    ...
                                    if (c && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = p.dataPoints[t].x.getTime ? p.dataPoints[t].x.getTime() : p.dataPoints[t].x, q = Math.floor((g - l) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), b) {
                                        ...
                                        if ((g = "waterfall" === a.type ? p.dataPointEOs[t].cumulativeSum : p.dataPoints[t].y) && g.length)
                                            for (var m = 0; m < g.length; m++)
                                                q = Math.floor((g[m] - h) / r), g[m] <
                                                    d[q].min && (d[q].min = g[m]), g[m] > d[q].max && (d[q].max = g[m]);
                                        else
                                            v(g) || (q = Math.floor((g - h) / r), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g));
                                    }
                        }
                }
            }
            ...
            if (g) {
                for (h = 0; h < this.plotInfo.plotTypes.length; h++)
                    for (g = this.plotInfo.plotTypes[h], k = 0; k < g.plotUnits.length; k++)
                        c = g.plotUnits[k], "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "bar" === c.type || "bubble" === c.type || "scatter" === c.type || "candlestick" === c.type || "ohlc" === c.type || "rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" ===
                ...
                for (h = 0; h < this._axes.length; h++)
                    if (this._axes[h].dataInfo._dataRanges) {
                        ...
                        var l = this._axes[h].dataInfo._dataRanges, u, q, g = [];
                        ...
                        if (this._axes[h].dataInfo.dataPointYNegativeSums) {
                            ...
                            u = l;
                            for (k in n)
                                n.hasOwnProperty(k) && !isNaN(k) && (q = -1 * n[k], v(q) || (f = Math.floor((q - t) / c), q < u[f].min && (u[f].min = q), q > u[f].max && (u[f].max = q)));
                            ...
                            if (u = l[k].max, isFinite(u))
                                for (; k < l.length - 1;)
                                    if (t = l[k + 1].min, isFinite(t)) {
                                        q = t - u;
                                        q > c && g.push({ diff: q, start: u, end: t });
                                        break;
                                    }
                                    else
                                        k++;
                            ...
                            for (k = 0; k < this._axes[h].scaleBreaks.customBreaks.length; k++)
                                for (c = 0; c < g.length; c++)
                                    if (this._axes[h].scaleBreaks.customBreaks[k].startValue <= g[c].start && g[c].start <= this._axes[h].scaleBreaks.customBreaks[k].endValue || this._axes[h].scaleBreaks.customBreaks[k].startValue <= g[c].start && g[c].start <= this._axes[h].scaleBreaks.customBreaks[k].endValue ||
                                        g[c].start <= this._axes[h].scaleBreaks.customBreaks[k].startValue && this._axes[h].scaleBreaks.customBreaks[k].startValue <= g[c].end || g[c].start <= this._axes[h].scaleBreaks.customBreaks[k].endValue && this._axes[h].scaleBreaks.customBreaks[k].endValue <= g[c].end)
                                        g.splice(c, 1), c--;
                        g.sort(function (a, c) { return c.diff - a.diff; });
                        for (k = 0; k < Math.min(g.length, this._axes[h].scaleBreaks.maxNumberOfAutoBreaks); k++)
                            c = a(g[k].start, g[k].end, this._axes[h].logarithmic ? this._axes[h].dataInfo.max / this._axes[h].dataInfo.min :
        ...
        m.prototype.getObjectAtXY = function (a, d, b) { var c = null; if (b = this.getDataPointAtXY(a, d, b || !1))
                ...
                if (!(b && 1 < b.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (b = 0; b < d.length; b++)
                            if (e = d[b], h = document.createEvent("MouseEvent"), h.initMouseEvent(e, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1, !1, !1, !1, 0, null), c.target.dispatchEvent(h), !v(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < g || "click" === e)
        ...
        m.prototype._plotAreaMouseUp = function (a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                var b = d - this.dragStartPoint.y, c = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = !1;
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX && 0 < this.axisX.length)
                    for (h = 0; h < this.axisX.length; h++)
                        this.axisX[h].crosshair && this.axisX[h].crosshair.enabled &&
                            this.axisX[h].renderCrosshair(a, d);
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (h = 0; h < this.axisX2.length; h++)
                        this.axisX2[h].crosshair && this.axisX2[h].crosshair.enabled && this.axisX2[h].renderCrosshair(a, d);
                if (this.axisY && 0 < this.axisY.length)
                    for (h = 0; h < this.axisY.length; h++)
                        this.axisY[h].crosshair && this.axisY[h].crosshair.enabled && this.axisY[h].renderCrosshair(a, d);
                if (this.axisY2 && 0 < this.axisY2.length)
                    for (h = 0; h < this.axisY2.length; h++)
                        this.axisY2[h].crosshair && this.axisY2[h].crosshair.enabled && this.axisY2[h].renderCrosshair(a, d);
            }
        };
        ...
        m.prototype.validateRegion = function (a, d, b, c, e) {
            e = e || !1;
            for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), k = !1, t = [], l = [], u = [], q = 0; q < this._axes.length; q++)
                ("axisX" === this._axes[q].type && g || "axisY" === this._axes[q].type && h) && l.push(this._axes[q]);
            for (h = 0; h < l.length; h++) {
                var q = l[h], g = !1, n = q.convertPixelToValue({ x: a, y: d }), f = q.convertPixelToValue({ x: b, y: c });
                if (n > f)
                    var A = f, f = n, n = A;
                if (q.scaleBreaks)
                    for (A = 0; !g && A < q.scaleBreaks._appliedBreaks.length; A++)
                        g = q.scaleBreaks._appliedBreaks[A].startValue <= n && q.scaleBreaks._appliedBreaks[A].endValue >= f;
                if (isFinite(q.dataInfo.minDiff))
                    if (A = q.getApparentDifference(n, f, null, !0), !(g || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && A < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && A < 3 * Math.abs(q.dataInfo.minDiff)) || n < q.minimum || f > q.maximum))
                        t.push(q), u.push({ val1: n, val2: f }), k =
                            !0;
                    else if (!e) {
                        k = !1;
                        break;
            ...
            return { isValid: k, axesWithValidRange: t, axesRanges: u };
        };
        ...
        m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, b = this.plotArea, c = 0, e = 0, g = 0, h = 0, k = c = h = e = g = 0, t = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var l = this._indexLabels[a], u = l.chartType.toLowerCase(), q, n, k = na("indexLabelFontColor", l.dataPoint, l.dataSeries), t = na("indexLabelFontSize", l.dataPoint, l.dataSeries);
                q = na("indexLabelFontFamily", l.dataPoint, l.dataSeries);
                n = na("indexLabelFontStyle", l.dataPoint, l.dataSeries);
                var h = na("indexLabelFontWeight", l.dataPoint, l.dataSeries), f = na("indexLabelBackgroundColor", l.dataPoint, l.dataSeries), e = na("indexLabelMaxWidth", l.dataPoint, l.dataSeries), g = na("indexLabelWrap", l.dataPoint, l.dataSeries), A = na("indexLabelLineDashType", l.dataPoint, l.dataSeries), p = na("indexLabelLineColor", l.dataPoint, l.dataSeries), m = v(l.dataPoint.indexLabelLineThickness) ? v(l.dataSeries.options.indexLabelLineThickness) ? 0 : l.dataSeries.options.indexLabelLineThickness : l.dataPoint.indexLabelLineThickness, c = 0 < m ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, s = { percent: null, total: null }, C = null;
                if (0 <= l.dataSeries.type.indexOf("stacked") || "pie" === l.dataSeries.type || "doughnut" === l.dataSeries.type)
                    s = this.getPercentAndTotal(l.dataSeries, l.dataPoint);
                if (l.dataSeries.indexLabelFormatter ||
                    l.dataPoint.indexLabelFormatter)
                    C = { chart: this, dataSeries: l.dataSeries, dataPoint: l.dataPoint, index: l.indexKeyword, total: s.total, percent: s.percent };
                var x = l.dataPoint.indexLabelFormatter ? l.dataPoint.indexLabelFormatter(C) : l.dataPoint.indexLabel ? this.replaceKeywordsWithValue(l.dataPoint.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : l.dataSeries.indexLabelFormatter ? l.dataSeries.indexLabelFormatter(C) : l.dataSeries.indexLabel ? this.replaceKeywordsWithValue(l.dataSeries.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : null;
                if (null !== x && "" !== x) {
                    var s = na("indexLabelPlacement", l.dataPoint, l.dataSeries), C = na("indexLabelOrientation", l.dataPoint, l.dataSeries), ma = l.direction, z = l.dataSeries.axisX, B = l.dataSeries.axisY, w = !1, f = new ka(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: g ? 5 * t : 1.5 * t, angle: "horizontal" === C ? 0 : -90, text: x, padding: 0, backgroundColor: f, horizontalAlign: "left", fontSize: t, fontFamily: q, fontWeight: h, fontColor: k, fontStyle: n, textBaseline: "top" });
                    f.measureText();
                    l.dataSeries.indexLabelMaxWidth =
                        f.maxWidth;
                    if ("stackedarea100" === u) {
                        if (l.point.x < b.x1 || l.point.x > b.x2 || l.point.y < b.y1 - 1 || l.point.y > b.y2 + 1)
                            continue;
                    }
                    else if ("rangearea" === u || "rangesplinearea" === u) {
                        if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x > z.viewportMaximum || Math.max.apply(null, l.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, l.dataPoint.y) > B.viewportMaximum)
                            continue;
                    }
                        ...
                        if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x > z.viewportMaximum ||
                            l.dataPoint.y < B.viewportMinimum || l.dataPoint.y > B.viewportMaximum)
                            continue;
                    }
                    else if (0 <= u.indexOf("column") || "waterfall" === u || "error" === u && !l.axisSwapped) {
                        if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x > z.viewportMaximum || l.bounds.y1 > b.y2 || l.bounds.y2 < b.y1)
                            continue;
                    }
                    else if (0 <= u.indexOf("bar") || "error" === u) {
                        if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x > z.viewportMaximum || l.bounds.x1 > b.x2 || l.bounds.x2 < b.x1)
                            continue;
                    }
                    else if ("candlestick" === u || "ohlc" === u) {
                        if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x >
                            z.viewportMaximum || Math.max.apply(null, l.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, l.dataPoint.y) > B.viewportMaximum)
                            continue;
                    }
                    else if (l.dataPoint.x < z.viewportMinimum || l.dataPoint.x > z.viewportMaximum)
                        continue;
                    e = h = 2;
                    "horizontal" === C ? (k = f.width, t = f.height) : (t = f.width, k = f.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= u.indexOf("line") || 0 <= u.indexOf("area"))
                            s = "auto", h = 4;
                        else if (0 <= u.indexOf("stacked"))
                            "auto" === s && (s = "inside");
                        else if ("bubble" === u || "scatter" === u)
                            s = "inside";
                        q = l.point.x -
                            k / 2;
                        ...
                        0 <= u.indexOf("line") || 0 <= u.indexOf("area") || 0 <= u.indexOf("scatter") ? (s = "auto", e = 4) : 0 <= u.indexOf("stacked") ? "auto" === s && (s = "inside") : "bubble" === u && (s = "inside"), n = l.point.y - t / 2, "inside" !== s ? (h = b.x1, g = b.x2, 0 > ma ? (q = l.point.x - k - e - c, q < h && (q = "auto" === s ? Math.max(l.point.x, h) + e + c : h + e + c, w = q + k > l.point.x)) : (q = l.point.x + e + c, q > g - k - e - c && (q = "auto" ===
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                l = this._indexLabels[a], f = na("indexLabelBackgroundColor", l.dataPoint, l.dataSeries), l.dataSeries.indexLabelBackgroundColor = v(f) ? r ? "transparent" : null : f;
            return d;
        };
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], h, k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var t = a.dataSeriesIndexes[k], l = this.data[t];
                    b.lineWidth = l.lineThickness;
                    var u = l.dataPoints, q = "solid";
                    if (b.setLineDash) {
                        var n = R(l.nullDataLineDashType, l.lineThickness), q = l.lineDashType, f = R(q, l.lineThickness);
                        b.setLineDash(f);
                    }
                    var A = l.id;
                    this._eventManager.objectMap[A] = { objectType: "dataSeries", dataSeriesIndex: t };
                    A = N(A);
                    c.strokeStyle = A;
                    c.lineWidth = 0 < l.lineThickness ? Math.max(l.lineThickness, 4) : 0;
                    var A = l._colorSet, p = A = l.lineColor = l.options.lineColor ? l.options.lineColor : A[0];
                    b.strokeStyle = A;
                    var m = !0, s = 0, C, x;
                    b.beginPath();
                    if (0 < u.length) {
                        for (var v = !1, s = 0; s < u.length; s++)
                            if (C = u[s].x.getTime ? u[s].x.getTime() : u[s].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !v)))
                                if ("number" !== typeof u[s].y)
                                    0 < s && !(l.connectNullData || v || m) && (b.stroke(), r && c.stroke()), v = !0;
                                else {
                                    C = a.axisX.convertValueToPixel(C);
                                    x =
                                        a.axisY.convertValueToPixel(u[s].y);
                                    var z = l.dataPointIds[s];
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: s, x1: C, y1: x };
                                    m || v ? (!m && l.connectNullData ? (b.setLineDash && (l.options.nullDataLineDashType || q === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(h.x, h.y), q = l.nullDataLineDashType, b.setLineDash(n)), b.lineTo(C, x), r && c.lineTo(C, x)) : (b.beginPath(), b.moveTo(C, x), r && (c.beginPath(), c.moveTo(C, x))), v = m = !1) : (b.lineTo(C, x), r && c.lineTo(C, x), 0 == s % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));
                                    h = { x: C, y: x };
                                    ...
                                    if (0 < u[s].markerSize || 0 < l.markerSize) {
                                        ...
                                        g.push(B);
                                        z = N(z);
                                        r && g.push({ x: C, y: x, ctx: c, type: B.type, size: B.size, color: z, borderColor: z, borderThickness: B.borderThickness });
                                    }
                                    (u[s].indexLabel || l.indexLabel || u[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: u[s], dataSeries: l, point: { x: C, y: x }, direction: 0 > u[s].y === a.axisY.reversed ? 1 : -1, color: A });
                                }
                        b.stroke();
                        r && c.stroke();
                    }
                    ...
                    if (0 < u.length) {
                        for (var v = !1, s = 0; s < u.length; s++)
                            if (C = u[s].getTime ? u[s].x.getTime() : u[s].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !v)))
                                if ("number" !== typeof u[s].y)
                                    0 < s && !(l.connectNullData || v || m) && (b.stroke(),
                                        r && c.stroke()), v = !0;
                                else {
                                    var z = x;
                                    C = a.axisX.convertValueToPixel(C);
                                    ...
                                    this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: s, x1: C, y1: x };
                                    m || v ? (!m && l.connectNullData ? (b.setLineDash && (l.options.nullDataLineDashType || q === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(h.x, h.y), q = l.nullDataLineDashType, b.setLineDash(n)), b.lineTo(C, z), b.lineTo(C, x), r && (c.lineTo(C, z), c.lineTo(C, x))) : (b.beginPath(), b.moveTo(C, x), r && (c.beginPath(), c.moveTo(C, x))), v = m = !1) : (b.lineTo(C, z), r && c.lineTo(C, z), b.lineTo(C, x), r && c.lineTo(C, x), 0 == s % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));
                                    h = { x: C, y: x };
                                    ...
                                    if (0 < u[s].markerSize || 0 < l.markerSize)
                                        z = l.getMarkerProperties(s, C, x, b), g.push(z), B = N(B), r && g.push({ x: C, y: x, ctx: c, type: z.type, size: z.size, color: B, borderColor: B, borderThickness: z.borderThickness });
                                    (u[s].indexLabel || l.indexLabel || u[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: u[s], dataSeries: l, point: { x: C, y: x }, direction: 0 > u[s].y === a.axisY.reversed ? 1 : -1, color: A });
                                }
                        b.stroke();
                        r && c.stroke();
                    }
                    ...
                    if (0 < u.length)
                        for (v = !1, m = 0; m < u.length; m++)
                            if (s = u[m].getTime ? u[m].x.getTime() : u[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !v)))
                                if ("number" !== typeof u[m].y)
                                    0 < m && !v && (l.connectNullData ? c.setLineDash && (0 < x.length && (l.options.nullDataLineDashType || !u[m - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = n, q = l.nullDataLineDashType) : (d(x), x = [])), v = !0;
                                else {
                                    s = a.axisX.convertValueToPixel(s);
                                    v = a.axisY.convertValueToPixel(u[m].y);
                                    var ma = l.dataPointIds[m];
                                    this._eventManager.objectMap[ma] = { id: ma, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: m, x1: s, y1: v };
                                    x[x.length] = { x: s, y: v };
                                    ...
                                    if (0 < u[m].markerSize || 0 < l.markerSize) {
                                        ...
                                        h.push(z);
                                        ma = N(ma);
                                        r && h.push({ x: s, y: v, ctx: e, type: z.type, size: z.size, color: ma, borderColor: ma, borderThickness: z.borderThickness });
                                    }
                                    (u[m].indexLabel || l.indexLabel || u[m].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: u[m], dataSeries: l, point: { x: s, y: v }, direction: 0 > u[m].y === a.axisY.reversed ? 1 : -1, color: A });
                                    v = !1;
                                }
                    d(x);
                }
        ...
        m.prototype.renderColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, k, t, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, q = a.axisX.dataInfo.minDiff;
                ...
                for (u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var n = a.dataSeriesIndexes[u], f = this.data[n], A = f.dataPoints;
                    if (0 < A.length)
                        for (var m = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < A.length; g++)
                            if (A[g].getTime ? t = A[g].x.getTime() :
                                ...
                                var p = a.axisX.reversed ? h - q << 0 : h + q << 0, s;
                                0 <= A[g].y ? s = l : (s = k, k = l);
                                k > s && (c = k, k = s, s = c);
                                c = A[g].color ? A[g].color : f._colorSet[g % f._colorSet.length];
                                ea(b, h, k, p, s, c, 0, null, m && 0 <= A[g].y, 0 > A[g].y && m, !1, !1, f.fillOpacity);
                                c = f.dataPointIds[g];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: h, y1: k, x2: p, y2: s };
                                c = N(c);
                                r && ea(this._eventManager.ghostCtx, h, k, p, s, c, 0, null, !1, !1, !1, !1);
                                (A[g].indexLabel || f.indexLabel || A[g].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: A[g], dataSeries: f, point: { x: h + (p - h) / 2, y: 0 > A[g].y === a.axisY.reversed ? k : s }, direction: 0 > A[g].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h,
                                        y1: Math.min(k, s), x2: p, y2: Math.max(k, s) }, color: c });
                            }
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: M.yScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: l < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : l > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : l };
            }
        };
        m.prototype.renderStackedColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var p = a.dataSeriesIndexes[A], m = this.data[p], s = m.dataPoints;
                    if (0 < s.length) {
                        ...
                        for (l = 0; l < s.length; l++)
                            if (c = s[l].x.getTime ? s[l].x.getTime() : s[l].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[l].y) {
                                ...
                                var x = u - a.plotType.plotUnits.length * f / 2 + a.index * f << 0, w = x + f << 0, z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[l].y)
                                    k[c] = s[l].y + (k[c] ? k[c] : 0), 0 < k[c] && (q = a.axisY.convertValueToPixel(k[c]),
                                        z = "undefined" !== typeof g[c] ? g[c] : n, g[c] = q);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[l].y)
                                    t[c] = s[l].y + (t[c] ? t[c] : 0), z = a.axisY.convertValueToPixel(t[c]), q = "undefined" !== typeof h[c] ? h[c] : n, h[c] = z;
                                    ...
                                    B = h[c] ? h[c] : 0, z = q + B, q = n + B, h[c] = B + (z - q);
                                c = s[l].color ? s[l].color : m._colorSet[l % m._colorSet.length];
                                ea(b, x, q, w, z, c, 0, null, v && 0 <= s[l].y, 0 > s[l].y && v, !1, !1, m.fillOpacity);
                                c = m.dataPointIds[l];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: l, x1: x, y1: q, x2: w, y2: z };
                                c = N(c);
                                r && ea(this._eventManager.ghostCtx, x, q, w, z, c, 0, null, !1, !1, !1, !1);
                                (s[l].indexLabel || m.indexLabel || s[l].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: s[l], dataSeries: m, point: { x: u, y: 0 <= s[l].y ? q : z }, direction: 0 > s[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: x, y1: Math.min(q, z), x2: w, y2: Math.max(q, z) }, color: c });
                            }
                    }
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = [], h = [], k = [], t = [], l = 0, u, q, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                ...
                r && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var m = a.dataSeriesIndexes[A], p = this.data[m], s = p.dataPoints;
                    if (0 < s.length)
                        for (var v = 5 < f && p.bevelEnabled ? !0 : !1, l = 0; l < s.length; l++)
                            if (c = s[l].x.getTime ? s[l].x.getTime() : s[l].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[l].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[l].y) {
                                    ...
                                    t[c] = q + ("undefined" !== typeof t[c] ? t[c] : 0), z = a.axisY.convertValueToPixel(t[c]), q = h[c] ? h[c] : n, h[c] = z;
                                ...
                                c = p.dataPointIds[l];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: l, x1: x, y1: q, x2: w, y2: z };
                                c = N(c);
                                r && ea(this._eventManager.ghostCtx, x, q, w, z, c, 0, null, !1, !1, !1, !1);
                                (s[l].indexLabel || p.indexLabel || s[l].indexLabelFormatter || p.indexLabelFormatter) &&
                                    this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: s[l], dataSeries: p, point: { x: u, y: 0 <= s[l].y ? q : z }, direction: 0 > s[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: x, y1: Math.min(q, z), x2: w, y2: Math.max(q, z) }, color: c });
                            }
                }
        ...
        m.prototype.renderBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, k, t, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, q = a.axisX.dataInfo.minDiff;
                isFinite(q) || (q = 0.3 * Math.abs(a.axisX.range));
                    ...
                    if (0 < A.length) {
                        ...
                        for (g = 0; g < A.length; g++)
                            if (A[g].getTime ? t = A[g].x.getTime() : t = A[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && "number" === typeof A[g].y) {
                                ...
                                var m = a.axisX.reversed ? k - q << 0 : k + q << 0, s;
                                0 <= A[g].y ? s = l : (s = h, h = l);
                                c = A[g].color ? A[g].color : f._colorSet[g % f._colorSet.length];
                                ea(b, s, k, h, m, c, 0, null, p, !1, !1, !1, f.fillOpacity);
                                c = f.dataPointIds[g];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: s, y1: k, x2: h, y2: m };
                                c =
                                    N(c);
                                r && ea(this._eventManager.ghostCtx, s, k, h, m, c, 0, null, !1, !1, !1, !1);
                                (A[g].indexLabel || f.indexLabel || A[g].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: A[g], dataSeries: f, point: { x: 0 <= A[g].y ? h : s, y: k + (m - k) / 2 }, direction: 0 > A[g].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, h), y1: k, x2: Math.max(s, h), y2: m }, color: c });
                            }
                    }
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: M.xScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: l < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : l > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                        l };
            }
        };
        m.prototype.renderStackedBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = [], h = [], k = [], t = [], l = 0, u, q, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < s.length) {
                        ...
                        for (l = 0; l < s.length; l++)
                            if (c = s[l].x.getTime ? s[l].x.getTime() :
                                ...
                                var x = q - a.plotType.plotUnits.length * f / 2 + a.index * f << 0, w = x + f << 0, z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[l].y)
                                    k[c] = s[l].y + (k[c] ? k[c] : 0), 0 < k[c] && (z = g[c] ? g[c] : n, g[c] = u = a.axisY.convertValueToPixel(k[c]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[l].y)
                                    t[c] = s[l].y + (t[c] ? t[c] : 0), u = h[c] ?
                                    ...
                                    B = h[c] ? h[c] : 0, z = u - B, u = n - B, h[c] = B + (u - z);
                                c = s[l].color ? s[l].color : p._colorSet[l % p._colorSet.length];
                                ea(b, z, x, u, w, c, 0, null, v, !1, !1, !1, p.fillOpacity);
                                c = p.dataPointIds[l];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: l, x1: z, y1: x, x2: u, y2: w };
                                c = N(c);
                                r && ea(this._eventManager.ghostCtx, z, x, u, w, c, 0, null, !1, !1, !1, !1);
                                (s[l].indexLabel || p.indexLabel || s[l].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: s[l], dataSeries: p, point: { x: 0 <= s[l].y ? u : z, y: q }, direction: 0 > s[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, u), y1: x, x2: Math.max(z, u), y2: w }, color: c });
                            }
                    }
                }
                    ...
                    if (0 < s.length) {
                        ...
                        for (l = 0; l < s.length; l++)
                            if (c = s[l].x.getTime ? s[l].x.getTime() : s[l].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                var w = q - a.plotType.plotUnits.length * f / 2 + a.index * f << 0, z = w + f << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[l].y) {
                                    k[c] = x + (k[c] ? k[c] : 0);
                                    if (0 >= k[c])
                                        continue;
                                    ...
                                    B = h[c] ? h[c] : 0, x = u - B, u = n - B, a.dataSeriesIndexes.length - 1 === A && 1 >= Math.abs(e.x1 - x) && (x = e.x1), h[c] = B + (u - x);
                                c = s[l].color ? s[l].color : m._colorSet[l % m._colorSet.length];
                                ea(b, x, w, u, z, c, 0, null, v, !1, !1, !1, m.fillOpacity);
                                c = m.dataPointIds[l];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: p,
                                    dataPointIndex: l, x1: x, y1: w, x2: u, y2: z };
                                c = N(c);
                                r && ea(this._eventManager.ghostCtx, x, w, u, z, c, 0, null, !1, !1, !1, !1);
                                (s[l].indexLabel || m.indexLabel || s[l].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: s[l], dataSeries: m, point: { x: 0 <= s[l].y ? u : x, y: q }, direction: 0 > s[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(x, u), y1: w, x2: Math.max(x, u), y2: z }, color: c });
                            }
                    }
                }
        ...
        m.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var f = a.dataSeriesIndexes[n], A = this.data[f], m = A.dataPoints, l = A.id;
                    this._eventManager.objectMap[l] = { objectType: "dataSeries",
                        dataSeriesIndex: f };
                    l = N(l);
                    h.fillStyle = l;
                    l = [];
                    d = !0;
                    var p = 0, s, v, x, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, B = null;
                    if (0 < m.length) {
                        var y = A._colorSet[p % A._colorSet.length], aa = A.lineColor = A.options.lineColor || y, T = aa;
                        g.fillStyle = y;
                        g.strokeStyle = aa;
                        ...
                        for (var da = !0; p < m.length; p++)
                            if (x = m[p].x.getTime ? m[p].x.getTime() :
                                ...
                                if ("number" !== typeof m[p].y)
                                    A.connectNullData || (da || d) || c(), da = !0;
                                else {
                                    s = a.axisX.convertValueToPixel(x);
                                    v = a.axisY.convertValueToPixel(m[p].y);
                                    d || da ? (!d && A.connectNullData ? (g.setLineDash && (A.options.nullDataLineDashType || b === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (d = s, b = v, s = q.x, v = q.y, c(), g.moveTo(q.x, q.y), s = d, v = b, B = q, b = A.nullDataLineDashType, g.setLineDash(Y)), g.lineTo(s, v), r && h.lineTo(s, v)) : (g.beginPath(), g.moveTo(s, v), r && (h.beginPath(), h.moveTo(s, v)), B = { x: s, y: v }), da = d = !1) : (g.lineTo(s, v), r && h.lineTo(s, v), 0 == p % 250 && c());
                                    q = { x: s, y: v };
                                    ...
                                    this._eventManager.objectMap[Z] = { id: Z, objectType: "dataPoint", dataSeriesIndex: f,
                                        dataPointIndex: p, x1: s, y1: v };
                                    0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < A.markerSize) && (x = A.getMarkerProperties(p, s, v, g), l.push(x), Z = N(Z), r && l.push({ x: s, y: v, ctx: h, type: x.type, size: x.size, color: Z, borderColor: Z, borderThickness: x.borderThickness }));
                                    (m[p].indexLabel || A.indexLabel || m[p].indexLabelFormatter || A.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: m[p], dataSeries: A, point: { x: s, y: v }, direction: 0 > m[p].y === a.axisY.reversed ? 1 : -1, color: y });
                                }
                        c();
                        ia.drawMarkers(l);
                    }
        ...
        m.prototype.renderSplineArea = function (a) {
            ...
            var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, g = a.axisX.lineCoordinates, h = a.axisY.lineCoordinates, k = [], t = this.plotArea;
                c.save();
                r &&
                    e.save();
                c.beginPath();
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var u = a.dataSeriesIndexes[l], q = this.data[u], n = q.dataPoints, k = q.id;
                    this._eventManager.objectMap[k] = { objectType: "dataSeries", dataSeriesIndex: u };
                    k = N(k);
                    e.fillStyle = k;
                    var k = [], f = 0, A, p, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s, v = null, x = [];
                    if (0 < n.length) {
                        var ma = q._colorSet[f % q._colorSet.length], z = q.lineColor = q.options.lineColor || ma, B = z;
                        c.fillStyle = ma;
                        c.strokeStyle = z;
                        c.lineWidth = q.lineThickness;
                        var y = "solid";
                        if (c.setLineDash) {
                            var aa = R(q.nullDataLineDashType, q.lineThickness), y = q.lineDashType, T = R(y, q.lineThickness);
                            c.setLineDash(T);
                        }
                        for (p = !1; f < n.length; f++)
                            if (A = n[f].x.getTime ? n[f].x.getTime() : n[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !p)))
                                if ("number" !== typeof n[f].y)
                                    0 < f && !p && (q.connectNullData ? c.setLineDash && (0 < x.length && (q.options.nullDataLineDashType ||
                                    ...
                                    this._eventManager.objectMap[Y] = { id: Y, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: f, x1: A, y1: p };
                                    x[x.length] = { x: A, y: p };
                                    ...
                                    if (0 !== n[f].markerSize && (0 < n[f].markerSize || 0 < q.markerSize)) {
                                        ...
                                        k.push(ca);
                                        Y = N(Y);
                                        r && k.push({ x: A, y: p, ctx: e, type: ca.type, size: ca.size, color: Y, borderColor: Y, borderThickness: ca.borderThickness });
                                    }
                                    (n[f].indexLabel || q.indexLabel || n[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: n[f], dataSeries: q,
                                        point: { x: A, y: p }, direction: 0 > n[f].y === a.axisY.reversed ? 1 : -1, color: ma });
                                    p = !1;
                                }
                        d();
                        ia.drawMarkers(k);
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            function c() {
                B && (0 < A.lineThickness && g.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = w : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = k.y2), g.lineTo(s, z), g.lineTo(B.x, z), g.closePath(), g.globalAlpha = A.fillOpacity, g.fill(), g.globalAlpha =
                    1, r && (h.lineTo(s, z), h.lineTo(B.x, z), h.closePath(), h.fill()), g.beginPath(), g.moveTo(s, v), h.beginPath(), h.moveTo(s, v), B = { x: s, y: v });
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx, g = r ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this._eventManager.ghostCtx, k = a.axisX.lineCoordinates, t = a.axisY.lineCoordinates, l = [], u = this.plotArea, q;
                ...
                r && (h.beginPath(), h.rect(u.x1, u.y1, u.width, u.height), h.clip());
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var f = a.dataSeriesIndexes[n], A = this.data[f], p = A.dataPoints, l = A.id;
                    this._eventManager.objectMap[l] = { objectType: "dataSeries", dataSeriesIndex: f };
                    l = N(l);
                    h.fillStyle = l;
                    l = [];
                    d = !0;
                    var m = 0, s, v, x, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, B = null;
                    b = !1;
                    if (0 < p.length) {
                        var y = A._colorSet[m % A._colorSet.length], aa = A.lineColor = A.options.lineColor || y, T = aa;
                        g.fillStyle = y;
                        g.strokeStyle = aa;
                        g.lineWidth = A.lineThickness;
                        var Y = "solid";
                        if (g.setLineDash) {
                            var ca = R(A.nullDataLineDashType, A.lineThickness), Y = A.lineDashType, da = R(Y, A.lineThickness);
                            g.setLineDash(da);
                        }
                        for (; m < p.length; m++)
                            if (x = p[m].x.getTime ? p[m].x.getTime() : p[m].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !b))) {
                                ...
                                "number" !== typeof p[m].y ? (A.connectNullData || (b || d) || c(), b = !0) : (s = a.axisX.convertValueToPixel(x), v = a.axisY.convertValueToPixel(p[m].y), d || b ? (!d && A.connectNullData ? (g.setLineDash && (A.options.nullDataLineDashType || Y === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (d =
                                    ...
                                    this._indexLabels.push({ chartType: "stepArea", dataPoint: p[m], dataSeries: A, point: { x: s, y: v }, direction: 0 > p[m].y === a.axisY.reversed ? 1 : -1, color: y }));
                            }
                        c();
                        ia.drawMarkers(l);
                    }
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, h = [], k = this.plotArea, t = [], l = [], u = [], q = [], n = 0, f, A, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m = this._eventManager.ghostCtx, s, v, x;
                r && m.beginPath();
                c.save();
                r && m.save();
                c.beginPath();
                ...
                for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var z = a.dataSeriesIndexes[w], B = this.data[z], y = B.dataPoints;
                    B.dataPointIndexes = [];
                    for (n = 0; n < y.length; n++)
                        z = y[n].x.getTime ? y[n].x.getTime() : y[n].x, B.dataPointIndexes[z] = n, e[z] || (u.push(z), e[z] = !0);
                    u.sort(Sa);
                }
                for (w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    m.fillStyle = n;
                    if (0 < u.length) {
                        var e = B._colorSet[0], aa = B.lineColor = B.options.lineColor || e, T = aa;
                        c.fillStyle =
                            e;
                        c.strokeStyle = aa;
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !da)))
                                if ("number" !== typeof Z.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        A = a.axisY.convertValueToPixel(Z.y), A -= oa;
                                    l.push({ x: f, y: p - oa });
                                    t[g] = p - A;
                                    v || da ? (!v && B.connectNullData ? (c.setLineDash && (B.options.nullDataLineDashType || x === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (v = l.pop(), x = l[l.length - 1], d(), c.moveTo(s.x, s.y), l.push(x), l.push(v), x = B.nullDataLineDashType,
                                        c.setLineDash(Y)), c.lineTo(f, A), r && m.lineTo(f, A)) : (c.beginPath(), c.moveTo(f, A), r && (m.beginPath(), m.moveTo(f, A))), da = v = !1) : (c.lineTo(f, A), r && m.lineTo(f, A), 0 == n % 250 && (d(), c.moveTo(f, A), r && m.moveTo(f, A), l.push({ x: f, y: p - oa })));
                                    s = { x: f, y: A };
                                    n < y.length - 1 && (T !== (y[n].lineColor || aa) || x !== (y[n].lineDashType || B.lineDashType)) && (d(), c.beginPath(), c.moveTo(f, A), l.push({ x: f, y: p - oa }), T = y[n].lineColor || aa, c.strokeStyle = T, c.setLineDash && (y[n].lineDashType ? (x = y[n].lineDashType, c.setLineDash(R(x, B.lineThickness))) :
                                        (x = B.lineDashType, c.setLineDash(ca))));
                                    if (0 <= B.dataPointIndexes[g]) {
                                        var la = B.dataPointIds[B.dataPointIndexes[g]];
                                        this._eventManager.objectMap[la] = { id: la, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: B.dataPointIndexes[g], x1: f, y1: A };
                                    }
                                    0 <= B.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < B.markerSize) && (oa = B.getMarkerProperties(B.dataPointIndexes[g], f, A, c), h.push(oa), g = N(la), r && h.push({ x: f, y: A, ctx: m, type: oa.type, size: oa.size, color: g, borderColor: g, borderThickness: oa.borderThickness }));
                                    (Z.indexLabel || B.indexLabel || Z.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: Z, dataSeries: B, point: { x: f, y: A }, direction: 0 > y[n].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        c.moveTo(f, A);
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, h = this.plotArea, k = [], t = [], l = [], u = [], q = [], n = 0, f, m, p, v, s, C = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx;
                c.save();
                r && x.save();
                c.beginPath();
                ...
                for (w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    l = [];
                    if (0 < u.length) {
                        var e = B._colorSet[n % B._colorSet.length], aa = B.lineColor = B.options.lineColor || e, T = aa;
                        c.fillStyle = e;
                        c.strokeStyle = aa;
                        c.lineWidth = B.lineThickness;
                        s = "solid";
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!B.connectNullData ||
                                ...
                                if ("number" !== typeof Z.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        m = a.axisY.convertValueToPixel(oa), m -= la;
                                    l.push({ x: f, y: C - la });
                                    t[g] = C - m;
                                    v || da ? (!v && B.connectNullData ? (c.setLineDash &&
                                        (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (v = l.pop(), s = l[l.length - 1], d(), c.moveTo(p.x, p.y), l.push(s), l.push(v), s = B.nullDataLineDashType, c.setLineDash(Y)), c.lineTo(f, m), r && x.lineTo(f, m)) : (c.beginPath(), c.moveTo(f, m), r && (x.beginPath(), x.moveTo(f, m))), da = v = !1) : (c.lineTo(f, m), r && x.lineTo(f, m), 0 == n % 250 && (d(), c.moveTo(f, m), r && x.moveTo(f, m), l.push({ x: f, y: C - la })));
                                    p = { x: f, y: m };
                                    n < y.length - 1 && (T !== (y[n].lineColor || aa) || s !== (y[n].lineDashType || B.lineDashType)) &&
                                        (d(), c.beginPath(), c.moveTo(f, m), l.push({ x: f, y: C - la }), T = y[n].lineColor || aa, c.strokeStyle = T, c.setLineDash && (y[n].lineDashType ? (s = y[n].lineDashType, c.setLineDash(R(s, B.lineThickness))) : (s = B.lineDashType, c.setLineDash(ca))));
                                    if (0 <= B.dataPointIndexes[g]) {
                                        var G = B.dataPointIds[B.dataPointIndexes[g]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: B.dataPointIndexes[g], x1: f, y1: m };
                                    }
                                    0 <= B.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < B.markerSize) && (la =
                                        B.getMarkerProperties(n, f, m, c), k.push(la), g = N(G), r && k.push({ x: f, y: m, ctx: x, type: la.type, size: la.size, color: g, borderColor: g, borderThickness: la.borderThickness }));
                                    (Z.indexLabel || B.indexLabel || Z.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: Z, dataSeries: B, point: { x: f, y: m }, direction: 0 > y[n].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        c.moveTo(f, m);
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = -Infinity, t = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                    for (var u = a.dataSeriesIndexes[l], q = this.data[u], n = q.dataPoints, f = 0, e = 0; e < n.length; e++)
                        g = n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[e].z || (f = n[e].z, f > k && (k = f), f < t && (t = f));
                    ...
                    if (u = a.dataSeriesIndexes[l], q = this.data[u], n = q.dataPoints, 0 < n.length)
                        for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++)
                            if (g = n[e].getTime ? g = n[e].x.getTime() :
                                ...
                                var f = n[e].z, v = 2 * Math.max(Math.sqrt((k === t ? p / 2 : m + (p - m) / (k - t) * (f - t)) / Math.PI) << 0, 1), f = q.getMarkerProperties(e, b);
                                f.size = v;
                                ...
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: u,
                                    dataPointIndex: e, x1: g, y1: h, size: v };
                                v = N(s);
                                r && ia.drawMarker(g, h, this._eventManager.ghostCtx, f.type, f.size, v, v, f.borderThickness);
                                (n[e].indexLabel || q.indexLabel || n[e].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: n[e], dataSeries: q, point: { x: g, y: h }, direction: 1, bounds: { x1: g - f.size / 2, y1: h - f.size / 2, x2: g + f.size / 2, y2: h + f.size / 2 }, color: null });
                            }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
        ...
        m.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var t = a.dataSeriesIndexes[k], l = this.data[t], u = l.dataPoints;
                    if (0 < u.length) {
                        b.strokeStyle =
                            "#4572A7 ";
                        ...
                        for (var q = 0, n = 0, e = 0; e < u.length; e++)
                            if (g = u[e].getTime ? g = u[e].x.getTime() : g = u[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[e].y) {
                                ...
                                b.globalAlpha = 1;
                                Math.sqrt((q - g) * (q - g) + (n - h) * (n - h)) < Math.min(f.size, 5) && u.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = l.dataPointIds[e], this._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: e, x1: g, y1: h }, q = N(q), r && ia.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, q, q, f.borderThickness), (u[e].indexLabel || l.indexLabel || u[e].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: u[e], dataSeries: l, point: { x: g, y: h }, direction: 1, bounds: { x1: g - f.size / 2, y1: h - f.size /
                                            2, x2: g + f.size / 2, y2: h + f.size / 2 }, color: null }), q = g, n = h);
                            }
                    }
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.restore());
        ...
        m.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, h = this.plotArea, k = 0, t, l, u, q, n, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ?
                    this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, m = a.axisX.dataInfo.minDiff;
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var w = a.dataSeriesIndexes[p], s = this.data[w], C = s.dataPoints;
                    if (0 < C.length)
                        for (var x = 5 < m && s.bevelEnabled ? !0 : !1, k = 0; k < C.length; k++)
                            if (C[k].getTime ? f = C[k].x.getTime() : f = C[k].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !v(C[k].y) && C[k].y.length &&
                                ...
                                var y = t - m / 2 << 0, z = y + m << 0, g = s.options.fallingColor ? s.fallingColor : s._colorSet[0], e = C[k].color ? C[k].color : s._colorSet[0], B = Math.round(Math.max(1, 0.15 * m)), D = 0 === B % 2 ? 0 : 0.5, aa = s.dataPointIds[k];
                                this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: k, x1: y, y1: l, x2: z, y2: u, x3: t, y3: q, x4: t, y4: n, borderThickness: B, color: e };
                                b.strokeStyle = e;
                                b.beginPath();
                                b.lineWidth = B;
                                ...
                                (C[k].indexLabel || s.indexLabel || C[k].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: s.type, dataPoint: C[k], dataSeries: s, point: { x: y + (z - y) / 2, y: a.axisY.reversed ? q : u }, direction: 1, bounds: { x1: y, y1: Math.min(u, q), x2: z, y2: Math.max(u, q) }, color: e });
                            }
                }
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d, c = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = this.plotArea, h = 0, k, t, l, u, q, n, f, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, h = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, m = a.axisX.dataInfo.minDiff;
                isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var p = !1, p = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var s = a.dataSeriesIndexes[w], C = this.data[s], x = C.dataPoints;
                    if (0 < x.length)
                        for (var y = 5 < m && C.bevelEnabled ? !0 : !1, h = 0; h < x.length; h++)
                            if (x[h].getTime ? f = x[h].x.getTime() : f = x[h].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !v(x[h].y) && x[h].y.length && "number" === typeof x[h].y[0] && "number" === typeof x[h].y[1] && "number" === typeof x[h].y[2] && "number" === typeof x[h].y[3] && "number" === typeof x[h].y[4] && 5 === x[h].y.length) {
                                ...
                                var z = k - m / 2 << 0, B = k + m / 2 << 0, e = x[h].color ? x[h].color : C._colorSet[0], D = Math.round(Math.max(1, 0.15 * m)), aa = 0 === D % 2 ? 0 : 0.5, T = x[h].whiskerColor ? x[h].whiskerColor : x[h].color ? C.whiskerColor ? C.whiskerColor : x[h].color : C.whiskerColor ? C.whiskerColor : e, Y = "number" === typeof x[h].whiskerThickness ? x[h].whiskerThickness : "number" === typeof C.options.whiskerThickness ? C.whiskerThickness : D, ca = x[h].whiskerDashType ? x[h].whiskerDashType : C.whiskerDashType, da = v(x[h].whiskerLength) ? v(C.options.whiskerLength) ? m : C.whiskerLength : x[h].whiskerLength, da = "number" === typeof da ? 0 >= da ? 0 : da >= m ? m : da : "string" === typeof da ? parseInt(da) * m / 100 > m ? m : parseInt(da) * m / 100 : m, Z = 1 === Math.round(Y) % 2 ? 0.5 : 0, oa = x[h].stemColor ? x[h].stemColor : x[h].color ? C.stemColor ? C.stemColor : x[h].color : C.stemColor ? C.stemColor : e, la = "number" === typeof x[h].stemThickness ? x[h].stemThickness : "number" === typeof C.options.stemThickness ? C.stemThickness : D, G = 1 === Math.round(la) % 2 ? 0.5 : 0, H = x[h].stemDashType ? x[h].stemDashType :
                                    C.stemDashType, E = x[h].lineColor ? x[h].lineColor : x[h].color ? C.lineColor ? C.lineColor : x[h].color : C.lineColor ? C.lineColor : e, F = "number" === typeof x[h].lineThickness ? x[h].lineThickness : "number" === typeof C.options.lineThickness ? C.lineThickness : D, I = x[h].lineDashType ? x[h].lineDashType : C.lineDashType, K = 1 === Math.round(F) % 2 ? 0.5 : 0, L = C.upperBoxColor, O = C.lowerBoxColor, Q = v(C.options.fillOpacity) ? 1 : C.fillOpacity, P = C.dataPointIds[h];
                                this._eventManager.objectMap[P] = { id: P, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: h,
                                    x1: z, y1: t, x2: B, y2: l, x3: k, y3: u, x4: k, y4: q, y5: n, borderThickness: D, color: e, stemThickness: la, stemColor: oa, whiskerThickness: Y, whiskerLength: da, whiskerColor: T, lineThickness: F, lineColor: E };
                                b.save();
                                ...
                                b.beginPath();
                                ea(b, z, Math.min(u, n), B, Math.max(n, u), L, 0, e, p ? !1 : y, p ? y : !1, !1, !1, Q);
                                b.beginPath();
                                b.lineWidth = D;
                                b.strokeStyle = e;
                                ...
                                (x[h].indexLabel || C.indexLabel || x[h].indexLabelFormatter ||
                                    C.indexLabelFormatter) && this._indexLabels.push({ chartType: C.type, dataPoint: x[h], dataSeries: C, point: { x: z + (B - z) / 2, y: a.axisY.reversed ? t : q }, direction: 1, bounds: { x1: z, y1: Math.min(t, q), x2: B, y2: Math.max(t, q) }, color: e });
                            }
                }
        ...
        m.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, k, t, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                    1;
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var q = a.dataSeriesIndexes[u], n = this.data[q], f = n.dataPoints;
                    if (0 < f.length)
                        for (var m = 5 < l && n.bevelEnabled ? !0 : !1, g = 0; g < f.length; g++)
                            if (f[g].getTime ? t = f[g].x.getTime() : t = f[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !v(f[g].y) && f[g].y.length && "number" === typeof f[g].y[0] && "number" === typeof f[g].y[1]) {
                                ...
                                var p = a.axisX.reversed ? c + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + u) * l << 0 : c - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount +
                                    u) * l << 0, w = a.axisX.reversed ? p - l << 0 : p + l << 0, c = f[g].color ? f[g].color : n._colorSet[g % n._colorSet.length];
                                if (h > k) {
                                    var s = h;
                                    h = k;
                                    k = s;
                                ...
                                s = n.dataPointIds[g];
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: g, x1: p, y1: h, x2: w, y2: k };
        ...
        m.prototype.renderError =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null, g = !1, h = this.plotArea, k = 0, t, l, u, q, n, f, m, p = a.axisX.dataInfo.minDiff;
                    ...
                    for (var w = 0, s = 0; s < this.data.length; s++)
                        !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && w || w++;
                    for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                        var x = a.dataSeriesIndexes[C], y = this.data[x], z = y.dataPoints, B = v(y._linkedSeries) ? !1 : y._linkedSeries.type.match(/(bar|column)/ig) && y._linkedSeries.visible ? !0 : !1, D = 0;
                        if (B)
                            for (e = y._linkedSeries.id, s = 0; s < e; s++)
                                !this.data[s].type.match(/(bar|column)/ig) ||
                        ...
                        if (0 < z.length)
                            for (var aa = y._colorSet, k = 0; k < z.length; k++) {
                                var e = y.lineColor = y.options.color ? y.options.color : aa[0], T = { color: z[k].whiskerColor ? z[k].whiskerColor : z[k].color ? y.whiskerColor ? y.whiskerColor : z[k].color : y.whiskerColor ? y.whiskerColor : e, thickness: v(z[k].whiskerThickness) ? y.whiskerThickness : z[k].whiskerThickness, dashType: z[k].whiskerDashType ? z[k].whiskerDashType : y.whiskerDashType, length: v(z[k].whiskerLength) ? v(y.options.whiskerLength) ? s : y.options.whiskerLength : z[k].whiskerLength,
                                ...
                                var Y = { color: z[k].stemColor ? z[k].stemColor : z[k].color ? y.stemColor ? y.stemColor : z[k].color : y.stemColor ? y.stemColor : e, thickness: z[k].stemThickness ? z[k].stemThickness : y.stemThickness, dashType: z[k].stemDashType ?
                                ...
                                if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !v(z[k].y) && z[k].y.length && "number" === typeof z[k].y[0] && "number" === typeof z[k].y[1]) {
                                    ...
                                    c && u > q && (ca = u, u = q, q = ca);
                                    ca = y.dataPointIds[k];
                                    this._eventManager.objectMap[ca] = { id: ca, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: k, x1: Math.min(u, q), y1: Math.min(n, f), x2: Math.max(q, u), y2: Math.max(f, n), isXYSwapped: c, stemProperties: Y, whiskerProperties: T };
                                    E(b, Math.min(u, q), Math.min(n, f), Math.max(q, u), Math.max(f, n), e, T, Y, c);
                                    r && E(this._eventManager.ghostCtx, u, n, q, f, e, T, Y, c);
                                    if (z[k].indexLabel || y.indexLabel || z[k].indexLabelFormatter || y.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "error", dataPoint: z[k], dataSeries: y, indexKeyword: 0, point: { x: c ? z[k].y[1] >= z[k].y[0] ? u : q : u + (q - u) / 2, y: c ? n + (f - n) / 2 : z[k].y[1] >= z[k].y[0] ? f : n }, direction: z[k].y[1] >= z[k].y[0] ? -1 : 1, bounds: { x1: c ? Math.min(u, q) : u, y1: c ? n : Math.min(n, f), x2: c ? Math.max(u, q) : q, y2: c ? f : Math.max(n, f) }, color: e, axisSwapped: c }),
                                            this._indexLabels.push({ chartType: "error", dataPoint: z[k], dataSeries: y, indexKeyword: 1, point: { x: c ? z[k].y[1] >= z[k].y[0] ? q : u : u + (q - u) / 2, y: c ? n + (f - n) / 2 : z[k].y[1] >= z[k].y[0] ? n : f }, direction: z[k].y[1] >= z[k].y[0] ? 1 : -1, bounds: { x1: c ? Math.min(u, q) : u, y1: c ? n : Math.min(n, f), x2: c ? Math.max(u, q) : q, y2: c ? f : Math.max(n, f) }, color: e, axisSwapped: c });
                                }
                            }
                    }
        ...
        m.prototype.renderRangeBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, k, t, l, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    var n = a.dataSeriesIndexes[q], f = this.data[n], m = f.dataPoints;
                    if (0 < m.length) {
                        ...
                        for (g = 0; g < m.length; g++)
                            if (m[g].getTime ? l = m[g].x.getTime() : l = m[g].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !v(m[g].y) && m[g].y.length && "number" === typeof m[g].y[0] && "number" === typeof m[g].y[1]) {
                                ...
                                if (m[g].indexLabel || f.indexLabel || m[g].indexLabelFormatter || f.indexLabelFormatter)
                                    this._indexLabels.push({ chartType: "rangeBar", dataPoint: m[g], dataSeries: f, indexKeyword: 0, point: { x: m[g].y[1] >= m[g].y[0] ? h : k, y: t + (w - t) / 2 }, direction: m[g].y[1] >= m[g].y[0] ? -1 : 1, bounds: { x1: Math.min(h, k), y1: t, x2: Math.max(h, k), y2: w }, color: c }), this._indexLabels.push({ chartType: "rangeBar", dataPoint: m[g], dataSeries: f, indexKeyword: 1, point: { x: m[g].y[1] >=
                                                m[g].y[0] ? k : h, y: t + (w - t) / 2 }, direction: m[g].y[1] >= m[g].y[0] ? 1 : -1, bounds: { x1: Math.min(h, k), y1: t, x2: Math.max(h, k), y2: w }, color: c });
                            }
                    }
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var t = [], l = a.dataSeriesIndexes[k], u = this.data[l], q = u.dataPoints, g = u.id;
                    this._eventManager.objectMap[g] = { objectType: "dataSeries", dataSeriesIndex: l };
                    g = N(g);
                    e.fillStyle = g;
                    var g = [], n = !0, f = 0, m, p, v, s, C = null;
                    if (0 < q.length) {
                        var x = u._colorSet[f % u._colorSet.length], w = u.lineColor = u.options.lineColor || x, z = w;
                        c.fillStyle = x;
                        c.strokeStyle = w;
                        c.lineWidth = u.lineThickness;
                        var B = "solid";
                        if (c.setLineDash) {
                            var y = R(u.nullDataLineDashType, u.lineThickness), B = u.lineDashType, D = R(B, u.lineThickness);
                            c.setLineDash(D);
                        }
                        for (var T = !0; f <
                            q.length; f++)
                            if (s = q[f].x.getTime ? q[f].x.getTime() : q[f].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!u.connectNullData || !T)))
                                if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
                                    ...
                                    n || T ? (u.connectNullData && !n ? (c.setLineDash && (u.options.nullDataLineDashType || B === u.lineDashType && u.lineDashType !== u.nullDataLineDashType) && (t[t.length -
                                        1].newLineDashArray = D, B = u.nullDataLineDashType, c.setLineDash(y)), c.lineTo(m, p), r && e.lineTo(m, p), t.push({ x: m, y: v })) : (c.beginPath(), c.moveTo(m, p), C = { x: m, y: p }, t = [], t.push({ x: m, y: v }), r && (e.beginPath(), e.moveTo(m, p))), T = n = !1) : (c.lineTo(m, p), t.push({ x: m, y: v }), r && e.lineTo(m, p), 0 == f % 250 && d());
                                    s = u.dataPointIds[f];
                                    this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: f, x1: m, y1: p, y2: v };
                                    ...
                                    if (0 !== q[f].markerSize && (0 < q[f].markerSize || 0 < u.markerSize)) {
                                        ...
                                        g.push(Y);
                                        var ca = N(s);
                                        r && g.push({ x: m, y: v, ctx: e, type: Y.type, size: Y.size, color: ca, borderColor: ca, borderThickness: Y.borderThickness });
                                        Y = u.getMarkerProperties(f, m, p, c);
                                        g.push(Y);
                                        ca = N(s);
                                        r && g.push({ x: m, y: p, ctx: e, type: Y.type, size: Y.size, color: ca, borderColor: ca, borderThickness: Y.borderThickness });
                                    }
                                    if (q[f].indexLabel || u.indexLabel || q[f].indexLabelFormatter || u.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: u, indexKeyword: 0, point: { x: m, y: p }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? -1 : 1, color: x }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: u, indexKeyword: 1, point: { x: m,
                                                y: v }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? 1 : -1, color: x });
                                }
                                else
                                    T || n || d(), T = !0;
                        d();
        ...
        m.prototype.renderRangeSplineArea = function (a) {
                    ...
                    if (0 < l.lineThickness) {
                        ...
                        for (var g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (p[g].newStrokeStyle || p[g].newLineDashArray)
                                c.stroke(), c.beginPath(), c.moveTo(d[f].x, d[f].y), p[g].newStrokeStyle && (c.strokeStyle = p[g].newStrokeStyle), p[g].newLineDashArray && c.setLineDash(p[g].newLineDashArray);
                            c.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                        }
                        c.stroke();
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                r && (e.beginPath(), e.rect(h.x1, h.y1, h.width, h.height), e.clip());
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var t = a.dataSeriesIndexes[k], l = this.data[t], u = l.dataPoints, g = l.id;
                    this._eventManager.objectMap[g] = { objectType: "dataSeries", dataSeriesIndex: t };
                    g = N(g);
                    e.fillStyle = g;
                    var g = [], q = 0, n, f, m, p = [], v = [];
                    if (0 < u.length) {
                        var s = l._colorSet[q % l._colorSet.length], C = l.lineColor = l.options.lineColor || s, x = C;
                        c.fillStyle = s;
                        c.lineWidth = l.lineThickness;
                        var y = "solid", z;
                        if (c.setLineDash) {
                            var B = R(l.nullDataLineDashType, l.lineThickness), y = l.lineDashType;
                            z = R(y, l.lineThickness);
                        }
                        for (f = !1; q < u.length; q++)
                            if (n = u[q].x.getTime ? u[q].x.getTime() : u[q].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !f)))
                                if (null !== u[q].y && u[q].y.length && "number" === typeof u[q].y[0] && "number" === typeof u[q].y[1]) {
                                    ...
                                    this._eventManager.objectMap[H] = { id: H, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: q,
                                        x1: n, y1: f, y2: m };
                                    p[p.length] = { x: n, y: f };
                                    v[v.length] = { x: n, y: m };
                                    ...
                                    if (0 !== u[q].markerSize && (0 < u[q].markerSize || 0 < l.markerSize)) {
                                        ...
                                        g.push(aa);
                                        T = N(H);
                                        r && g.push({ x: n, y: m, ctx: e, type: aa.type, size: aa.size, color: T, borderColor: T, borderThickness: aa.borderThickness });
                                    }
                                    if (u[q].indexLabel || l.indexLabel || u[q].indexLabelFormatter || l.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: u[q], dataSeries: l, indexKeyword: 0, point: { x: n, y: f }, direction: u[q].y[0] <= u[q].y[1] ? -1 : 1, color: s }), this._indexLabels.push({ chartType: "rangeSplineArea",
                                            dataPoint: u[q], dataSeries: l, indexKeyword: 1, point: { x: n, y: m }, direction: u[q].y[0] <= u[q].y[1] ? 1 : -1, color: s });
                                    f = !1;
                                }
                                else
                                    0 < q && !f && (l.connectNullData ? c.setLineDash && (0 < p.length && (l.options.nullDataLineDashType || !u[q - 1].lineDashType)) && (p[p.length - 1].newLineDashArray = B, y = l.nullDataLineDashType) : (d(z, C), p = [], v = [])), f = !0;
                        d(z, C);
                        ia.drawMarkers(g);
                    }
                }
        ...
        m.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = this._eventManager.ghostCtx, e = null, g = this.plotArea, h = 0, k, t, l, u, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                    var m = a.dataSeriesIndexes[f], p = this.data[m], v = p.dataPoints, e = p._colorSet[0];
                    ...
                    var s = "number" === typeof p.options.lineThickness ? Math.round(p.lineThickness) : 1, w = 1 === Math.round(s) % 2 ? -0.5 : 0;
                    if (0 < v.length)
                        for (var x = 5 < n && p.bevelEnabled ? !0 : !1, y = !1, z = null, B = null, h = 0; h < v.length; h++)
                            if (v[h].getTime ? u = v[h].x.getTime() : u = v[h].x, "number" !== typeof v[h].y) {
                                if (0 < h && !y && p.connectNullData)
                                    var D = p.options.nullDataLineDashType || !v[h - 1].lineDashType ? p.nullDataLineDashType : v[h - 1].lineDashType;
                                y = !0;
                            }
                            else {
                                ...
                                e = p.dataPointIds[h];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: h, x1: k, y1: t, x2: H, y2: l };
                                ...
                                (v[h].indexLabel || p.indexLabel || v[h].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: v[h], dataSeries: p, point: { x: k +
                                            (H - k) / 2, y: 0 <= v[h].y ? t : l }, direction: 0 > v[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: k, y1: Math.min(t, l), x2: H, y2: Math.max(t, l) }, color: e });
                            }
                }
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (l && m) {
                    for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < m.length; d++) {
                        var g = m[d], k = l.dataPointIds[d];
                        f[d].id = k;
                        f[d].objectType = "dataPoint";
                        f[d].dataPointIndex = d;
                        f[d].dataSeriesIndex = 0;
                        var h = f[d], q = { percent: null, total: null }, p = null, q = t.getPercentAndTotal(l, g);
                        if (l.indexLabelFormatter || g.indexLabelFormatter)
                            p = { chart: t.options, dataSeries: l, dataPoint: g, total: q.total, percent: q.percent };
                        ...
                        if (h.midAngle > Math.PI / 2 - s && h.midAngle < Math.PI / 2 + s) {
                            ...
                            if (0 === b || f[e].midAngle > h.midAngle)
                                e = d;
                            b++;
                        }
                        h.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
                        h.indexLabelTextBlock = new ka(t.plotArea.ctx, { fontSize: h.indexLabelFontSize, fontFamily: h.indexLabelFontFamily, fontColor: h.indexLabelFontColor, fontStyle: h.indexLabelFontStyle, fontWeight: h.indexLabelFontWeight, horizontalAlign: "left", backgroundColor: h.indexLabelBackgroundColor, maxWidth: h.indexLabelMaxWidth, maxHeight: h.indexLabelWrap ?
                                5 * h.indexLabelFontSize : 1.5 * h.indexLabelFontSize, text: h.indexLabelText, padding: 0, textBaseline: "top" });
                        h.indexLabelTextBlock.measureText();
                    }
                    k = g = 0;
                    q = !1;
                    for (d = 0; d < m.length; d++)
                        h = f[(c + d) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - s && h.midAngle < Math.PI / 2 + s) && (g <= a / 2 && !q ? (h.hemisphere = "right", g++) : (h.hemisphere = "left", q = !0));
                    q = !1;
                    for (d = 0; d < m.length; d++)
                        h = f[(e + d) % m.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - s && h.midAngle < 3 * Math.PI / 2 + s) && (k <= b / 2 && !q ? (h.hemisphere = "left", k++) : (h.hemisphere = "right", q = !0));
                }
            }
            function b(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (e > c) {
                        var d = 0.07 * B * Math.cos(f[b].midAngle), g = 0.07 * B * Math.sin(f[b].midAngle), h = !1;
                        if (m[b].exploded) {
            ...
            function e(a) { for (var b = null, e = 1; e < m.length; e++)
            ...
            function g(a, b, d) {
                ...
                if (1E3 <
                    ...
                    return 0;
                b = b || 0;
                var h = 0, l = x.y - 1 * r, k = x.y + 1 * r;
                if (0 <= a && a < m.length) {
                    var n = f[a];
                    if (0 > b && n.indexLabelTextBlock.y < l || 0 < b && n.indexLabelTextBlock.y > k)
                        return 0;
                    var q = 0, t = 0, t = q = q = 0;
                    ...
                    for (k = 1; k < m.length; k++)
                        if (l = (a - k + f.length) % f.length, f[l].hemisphere !== f[a].hemisphere) {
                            ...
                            f[l].hemisphere === f[a].hemisphere && l !== a && (0 > c(f[l], f[a]) || ("right" === f[a].hemisphere ? f[l].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[l].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y)))
                            break;
                        else
                            l = null;
                    t = l;
            ...
            function h() {
                ...
                for (var b = a = 0, d = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                    if (l.radius || !l.radius && "undefined" !== typeof l.innerRadius && null !== l.innerRadius && B - d <= D)
                        h = !1;
                    h && (B -= d);
                    d = 0;
                    if ("inside" !== l.indexLabelPlacement) {
                        ...
                        for (var s, v, a = 0; a < m.length; a++) {
                            ...
                            if (null !== z) {
                                ...
                                var y = 0, y = c(s, v) - p;
                                if (0 > y) {
                                    for (var E = v = 0, F = 0; F < m.length; F++)
                                        F !== a && f[F].hemisphere === k.hemisphere && (f[F].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? v++ : E++);
                                    v = y / (v + E || 1) * E;
                                    var E = -1 * (y - v), I = F = 0;
                        ...
                        for (a = 0; a < m.length; a++)
                            k = f[a], r = "pie" === l.type ? 0.7 * B : 0.8 * B, z = x.x + r * Math.cos(k.midAngle), v = x.y + r * Math.sin(k.midAngle), k.indexLabelTextBlock.x = z, k.indexLabelTextBlock.y = v;
                    for (a = 0; a < m.length; a++)
                        if (k = f[a], z = k.indexLabelTextBlock.measureText(), 0 !== z.height && 0 !== z.width)
                            z = z = 0, "right" === k.hemisphere ? (z = n.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width +
                    ...
                    var K = function (a, b, c) { for (var e = [], d = 0; e.push(f[b]), b !== c; b = (b + 1 + m.length) % m.length)
                                ...
                                if (null !== h) {
                                    ...
                                    if (n = 0 > y) {
                                        ...
                                        var t = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height /
                                            2, p = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2, r = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2, v = l.indexLabelTextBlock.x + l.indexLabelTextBlock.width, A = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2;
            ...
            var t = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this.data[a.dataSeriesIndexes[0]], m = l.dataPoints, q = 10, n = this.plotArea, f = l.dataPointEOs, p = 2, r, w = 1.3, s = 20 / 180 * Math.PI, C = 6, x = { x: (n.x2 + n.x1) / 2, y: (n.y2 + n.y1) / 2 }, y = 0;
                a = !1;
                for (var z = 0; z < m.length; z++)
                    y += Math.abs(m[z].y), !a && ("undefined" !== typeof m[z].indexLabel && null !== m[z].indexLabel && 0 < m[z].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[z].label && null !== m[z].label && 0 < m[z].label.toString().length) && (a = !0);
                if (0 !== y) {
                    ...
                    this.pieDoughnutClickHandler = function (a) {
                        t.isAnimating || !v(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && t._animator.animate(0, 500, function (a) { b(a); k(); }));
                    };
                    d();
                    h();
                    h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        for (b = 0; b < m.length; b++) {
                            ...
                            e > c && ja(t.plotArea.ctx, f[b].center, f[b].radius, g, l.type, c, e, l.fillOpacity, f[b].percentInnerRadius);
                            if (d)
                                break;
                        }
                        k();
                    }, function () { t.disableToolTip = !1; t._animator.animate(0, t.animatedRender ? 500 : 0, function (a) { b(a); k(); }); });
                }
            }
        };
        ...
        m.prototype.renderFunnel = function (a) {
            function d() { for (var a = 0, b = [], c = 0; c < C.length; c++) {
                ...
                b.push(Math.abs(C[c].y) * H / a); return b; }
            function b() {
                ...
                if (0 === g)
                    return -1;
                for (var l = e[0] = 0, h = 0, n, q, b = b - a, l = !1, k = 0; k < C.length; k++)
                    a = Math.abs(C[k].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (q = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > q ? (q = c, l = (b + q) * (d - h) / 2, a -= l, n = d - h, h += d - h, n += 0 == q ? 0 : a / q, h += a / q, l = !0) : (n = (Math.abs(ba) * b - Math.sqrt(q)) / 2, q = b - 2 * n / Math.abs(ba), h += n, h > d && (h -= n,
                        q = c, l = (b + q) * (d - h) / 2, a -= l, n = d - h, h += d - h, n += a / q, h += a / q, l = !0), b = q)), e.push(n);
                return e;
            }
            function c() {
                if (s && C) {
                    for (var a, b, c, e, d, g, k, h, l, n, q, m, t, p, u = [], A = [], x = { percent: null, total: null }, z = null, w = 0; w < C.length; w++)
                        p = P[w], p = "undefined" !== typeof p.x5 ? (p.y2 + p.y4) / 2 : (p.y2 + p.y3) / 2, p = f(p).x2 + 1, u[w] = L - p - S;
                    p = 0.5 * S;
                    for (var w = 0, B = C.length - 1; w < C.length || 0 <= B; w++, B--) {
                        ...
                        t = s.dataPointIds[w];
                        y._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataPointIndex: w, dataSeriesIndex: 0, funnelSection: P[s.reversed ? C.length - 1 - w : w] };
                        ...
                        if (s.indexLabelFormatter || b.indexLabelFormatter)
                            z = { chart: y.options, dataSeries: s, dataPoint: b, total: x.total, percent: x.percent };
                        ...
                        Q.roundRect || Ea(Q);
                        c = new ka(Q, { fontSize: g, fontFamily: h, fontColor: d, fontStyle: k, fontWeight: l, horizontalAlign: c, backgroundColor: e, maxWidth: t, maxHeight: !1 === A[w] ? m ? 4.28571429 * g : 1.5 * g : A[w], text: b, padding: ga });
                        c.measureText();
                        J.push({ textBlock: c, id: s.reversed ? B : w, isDirty: !1, lineColor: a, lineThickness: n,
                            lineDashType: q, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth });
                    }
                }
            }
            function e() {
            ...
            function g() {
                ...
                if ("inside" !== s.indexLabelPlacement)
                    for (var d = 0; d < P.length; d++)
                        0 == J[d].textBlock.text.length ? J[d].isDirty = !0 : (a = P[d], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = s.reversed ? "undefined" !== typeof a.x5 ? c > Da ? f(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Da ? f(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, J[d].textBlock.x = b + S, J[d].textBlock.y =
            ...
            function h() {
                ...
                function b() {
                    ...
                    for (var k, l = 1; l < h; l++) {
                        e = l * f;
                        for (var t = J.length - 1; 0 <= t; t--)
                            !J[t].isDirty && (J[t].textBlock.y <
            ...
            function k(a, b) { return (b < P.length ? J[b].textBlock.y : s.reversed ? pa + D : wa + D) - (0 > a ? s.reversed ? wa - D : pa - D : J[a].textBlock.y + J[a].height + ga); }
            function m(a, b, c) {
                var d, e, f, h = [], k = D, n = [];
                ...
                f = function () { for (var a = [], b = 0; b < P.length; b++)
                    a.push(h[b] - P[b].y1); return a; }();
                var t = { startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, d) { return M.easing.easeOutQuart(a, b, c, d); }, changeSection: function (a) {
            ...
            function A(a) { for (var b = 0; b < P.length; b++)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var s = this.data[a.dataSeriesIndexes[0]], C = s.dataPoints, x = this.plotArea, D = 0.025 * x.width, z = 0.01 * x.width, B = 0, H = x.height - 2 * D, E = Math.min(x.width - 2 * z, 2.8 * x.height), F = !1, I = 0; I < C.length; I++)
                    if (!F && ("undefined" !== typeof C[I].indexLabel && null !== C[I].indexLabel &&
                        0 < C[I].indexLabel.toString().length) && (F = !0), !F && ("undefined" !== typeof C[I].label && null !== C[I].label && 0 < C[I].label.toString().length) && (F = !0), !F && "function" === typeof s.indexLabelFormatter || "function" === typeof C[I].indexLabelFormatter)
                        F = !0;
                ...
                var I = x.x1 + z, L = x.x2 - z, O = x.y1 + D, Z = x.y2 - D, Q = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != s.length && (s.dataPoints &&
                    ...
                    var z = I + a / 2, $ = I, V = I + a, pa = s.reversed ? Z : O, K = z - G / 2, ea = z + G / 2, Da = s.reversed ? O + N : Z -
                        N, wa = s.reversed ? O : Z;
                    a = [];
                    var z = [], P = [], E = [], X = O, fa, ba = (Da - pa) / (K - $), ha = -ba, I = "area" === (s.valueRepresents ? s.valueRepresents : "height") ? b() : d();
                    if (-1 !== I) {
                        if (s.reversed)
                        ...
                        if (s.reversed)
                            for (G = 0; G < I.length; G++)
                                E[G] < Da ? (a.push(K), z.push(ea), fa = G) : (a.push((E[G] - pa + ba * $) / ba), z.push((E[G] - pa + ha * V) / ha));
                        else
                            for (G = 0; G < I.length; G++)
                                E[G] < Da ? (a.push((E[G] - pa + ba * $) / ba), z.push((E[G] - pa + ha * V) / ha), fa = G) : (a.push(K), z.push(ea));
                        for (G = 0; G < I.length - 1; G++)
                            X = s.reversed ? C[C.length - 1 - G].color ? C[C.length - 1 - G].color : s._colorSet[(C.length - 1 - G) % s._colorSet.length] : C[G].color ? C[G].color : s._colorSet[G % s._colorSet.length], G === fa ? P.push({ x1: a[G], y1: E[G], x2: z[G], y2: E[G], x3: ea, y3: Da, x4: z[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: K, y6: Da, id: G, height: E[G + 1] - E[G], color: X }) : P.push({ x1: a[G], y1: E[G], x2: z[G], y2: E[G], x3: z[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: X });
                        var ga = 2, J = [], ja = !1, W = [], ia = [], I = !1;
                        a = a = 0;
                        Fa(W);
                        for (G = 0; G <
                            C.length; G++)
                            C[G].exploded && (I = !0, s.reversed ? W.push(C.length - 1 - G) : W.push(G));
                        ...
                        if (F && s.visible && (c(), g(), e(), "inside" !== s.indexLabelPlacement)) {
                            ...
                            for (G = 0; G < C.length; G++)
                                J[G].isDirty || (a = J[G].textBlock.x + J[G].width, a = (L - a) / 2, 0 == G && (B = a), B > a && (B = a));
                            for (G = 0; G < P.length; G++)
                                P[G].x1 += B, P[G].x2 += B, P[G].x3 += B, P[G].x4 += B, P[G].x5 && (P[G].x5 += B, P[G].x6 += B), J[G].textBlock.x += B;
                        }
                        for (G = 0; G < P.length; G++)
                            B =
                        ...
                        if (!F)
                            for (G = 0; G < C.length; G++)
                                B = s.dataPointIds[G], a = { id: B, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: P[s.reversed ? C.length - 1 - G : G] }, y._eventManager.objectMap[B] = a;
                        ...
                        this.funnelPyramidClickHandler = function (a) {
                            ...
                            if (!ja && !y.isAnimating && (v(a.dataSeries.explodeOnClick) ||
                                ...
                                if ("funnel" === s.type || "pyramid" === s.type)
                                    s.reversed ? C[C.length - 1 - a].exploded = C[C.length - 1 - a].exploded ? !1 : !0 : C[a].exploded = C[a].exploded ? !1 : !0;
                                m(y, b, 500);
                            }
                        };
                        return { source: Q, dest: this.plotArea.ctx, animationCallback: function (a, b) { M.fadeInAnimation(a, b); 1 <= a && (m(y, -1, 500), w(y.plotArea.ctx || y.ctx)); }, easingFunction: M.easing.easeInQuad, animationBase: 0 };
                    }
                }
            }
        };
        ...
        m.prototype.exportChart = function (a) { a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", b = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL)
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, b, c, e) {
            ...
            if ((0 <= b.type.indexOf("stacked") ||
                ...
                var h = "#percent", k = "#total", t = this.getPercentAndTotal(b, d), k = isNaN(t.total) ? k : t.total, h = isNaN(t.percent) ? h : t.percent;
                do {
                    t = "";
                    if (b.percentFormatString)
                        t = b.percentFormatString;
                    else {
                        var t = "#,##0.", l = Math.max(Math.ceil(Math.log(1 / Math.abs(h)) / Math.LN10), 2);
        ...
        F.prototype.setLayout = function () {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = null, c = 0, e = 0, g = 0, h = 0, k = this.markerMargin = this.chart.options.legend && !v(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
            this.height = 0;
            var t = [], l = [];
            ...
            for (var m = 0; m < this.dataSeries.length; m++) {
                ...
                if (q.dataPoints && q.dataPoints.length)
                    if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                        var n = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ? "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(q._linkedSeries.type) : H.getDefaultLegendMarker(q.type) : q.markerType, f = q.legendText ? q.legendText :
                        ...
                        n = { markerType: n, markerColor: p, text: f, textBlock: null, chartType: q.type, markerSize: r, lineColor: q._colorSet[0], dataSeriesIndex: q.index, dataPointIndex: null, markerBorderColor: w, markerBorderThickness: s };
                        t.push(n);
                    }
                    else
                        for (var y = 0; y < q.dataPoints.length; y++) {
                            var x = q.dataPoints[y], n = x.legendMarkerType ? x.legendMarkerType : q.legendMarkerType ? q.legendMarkerType :
                ...
                for (m = 0; m < t.length; m++) {
                    ...
                    if (!(0 >= h || "undefined" ===
                        ...
                        if ("horizontal" === this.orientation) {
                            n.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: w, maxHeight: this.itemWrap ? h : this.lineHeight, angle: 0, text: n.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" });
                            ...
                            if (!q || q.width + Math.round(n.textBlock.width + r + k + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g)
                                q = { items: [], width: 0 }, l.push(q), this.height += f, f = 0;
                            f = Math.max(f, n.textBlock.height);
                        }
                        else
                            n.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: x, maxHeight: !0 === this.itemWrap ? h : 1.5 * this.fontSize, angle: 0, text: n.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily,
                                fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }), n.textBlock.measureText(), null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + k + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < h - this.lineHeight ? (q = { items: [], width: 0 }, l.push(q)) : (q = l[y], y = (y + 1) % l.length), this.height += n.textBlock.height;
            ...
            for (m = 0; m < this.items.length; m++)
                n = t[m], n.id = ++this.chart._eventManager.lastObjectId,
                    this.chart._eventManager.objectMap[n.id] = { id: n.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: n.dataSeriesIndex, dataPointIndex: n.dataPointIndex };
            this.markerSize = r;
            this.rows = l;
            0 < t.length && a.layoutManager.registerSpace(b, { width: this.width + 2 + 2, height: this.height + 5 + 5 });
            this.bounds = { x1: e, y1: c, x2: e + this.width, y2: c + this.height };
        };
        F.prototype.render = function () {
            var a = this.bounds.x1, d = this.bounds.y1, b = this.markerMargin, c = this.maxWidth, e = this.maxHeight, g = this.markerSize, h = this.rows;
            ...
            for (var k = 0, m = 0; m < h.length; m++) {
                for (var l = h[m], p = 0, q = 0; q < l.items.length; q++) {
                    var n = l.items[q], f = n.textBlock.x + a + (0 === q ? 0.2 * g : this.horizontalSpacing), r = d + k, v = f;
                    ...
                    if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                        this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(f - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(f + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), v -= 0.1 * this.lineHeight;
                    if ("error" === n.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = g / 8;
                        this.ctx.beginPath();
                        var w = f - 0.08 * this.lineHeight + 0.1 * this.lineHeight, s = r + 0.15 * this.lineHeight, y = 0.7 * this.lineHeight, x = y + 0.02 * this.lineHeight;
                        this.ctx.moveTo(w, s);
                    ...
                    ia.drawMarker(f + g / 2, r + this.lineHeight / 2, this.ctx, n.markerType, "error" === n.chartType || "line" === n.chartType || "spline" === n.chartType ? n.markerSize / 2 : n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
                    n.textBlock.x = f + b + g;
                    if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
        ...
        H.prototype.getDataPointAtX = function (a, d) {
            if (!this.dataPoints || 0 === this.dataPoints.length)
                return null;
            var b = { dataPoint: null, distance: Infinity, index: NaN }, c = null, e = 0, g = 0, h = 1, k = Infinity, m = 0, l = 0, p = 0;
        ...
        H.prototype.getDataPointAtXY = function (a, d, b) {
            if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2)
                return null;
            b = b || !1;
            var c = [], e = 0, g = 0, h = 1, k = !1, m = Infinity, l = 0, p = 0, q = 0;
            ...
            for (;;) {
                g = 0 < h ? q + e : q - e;
                if (0 <= g && g < this.dataPoints.length) {
                    var n = this.chart._eventManager.objectMap[this.dataPointIds[g]], f = this.dataPoints[g], r = null;
                    if (n) {
                        switch (this.type) {
                            case "column":
                            case "stackedColumn":
                            ...
                            case "error":
                                a >= n.x1 && (a <= n.x2 && d >= n.y1 && d <= n.y2) && (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 -
                                        a), Math.abs(n.x2 - a), Math.abs(n.y1 - d), Math.abs(n.y2 - d)) }), k = !0);
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "splineArea":
                            case "scatter":
                                var v = na("markerSize", f, this) || 4, w = b ? 20 : v, r = Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - d, 2));
                                r <= w && c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: r });
                                n = Math.abs(n.x1 - a);
                                n <= m ? m = n : 0 < h ? l++ : p++;
                                r <= v / 2 && (k = !0);
                                break;
                            ...
                            case "bubble":
                                ...
                                r <= v / 2 && (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: r }), k = !0);
                                break;
                            case "pie":
                            case "doughnut":
                                v = n.center;
                                ...
                                r < n.radius && r > w && (r = Math.atan2(d - v.y, a - v.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (n.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (n.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < n.endAngle && (w = 360), v >= w && 0 !== f.y && (w += 360, r < v && (r += 360)), r > v && r < w && (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: 0 }), k = !0));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = n.funnelSection;
                            ...
                            case "boxAndWhisker":
                                if (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && d >= n.y4 - n.borderThickness / 2 && d <= n.y1 + n.borderThickness /
                                    ...
                                    c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y2 - d), Math.abs(n.y3 - d)) }), k = !0;
                                break;
                            case "candlestick":
        ...
        y.prototype.createExtraLabelsForLog = function (a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                    for (var b = y.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < d; c += b)
        ...
        y.prototype.createLabels = function () {
            var a, d, b = 0, c = 0, e, g = 0, h = 0, c = 0, c = this.interval, k = 0, m, l = 0.6 * this.chart.height, p;
            a = !1;
            var q = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], n = q.length ? v(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0;
            ...
            if ("bottom" === this._position || "top" === this._position)
                ...
                k = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length -
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (v(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                for (var w, f = a.text.split(" "), c = 0; c < f.length; c++)
                                    p = f[c], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, p = this.ctx.measureText(p), p.width > n && (w = b, n = p.width);
                            }
                        b = 0;
                        for (b = this.intervalStartPosition <
                            ...
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                if (v(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), p = (l - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !v(this.options.labelWrap))
                                        this.labelWrap ? v(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth =
                                        ...
                                        if (v(this.options.labelWrap))
                                            if (!v(this.options.labelMaxWidth))
                                                ...
                                                if (c = A.width + d.width >> 0, f = this.labelFontSize, n < g)
                                                    c - 2 * g > q && (q = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, v(this.options.labelFontSize) && 12 < f && (f = Math.floor(12 / 13 * f), a.measureText()), this.sessionVariables.labelFontSize = v(this.options.labelFontSize) ? f : this.options.labelFontSize, this.sessionVariables.labelAngle =
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = v(this.options.labelFontSize) ? f : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, c = 0; c < this._labels.length; c++)
                                                        a =
                    ...
                    if (g = v(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, h = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = v(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                var g = this.stripLines[b], y;
                if ("outside" === g.labelPlacement) {
                    h = this.sessionVariables.labelMaxWidth;
                    if ("bottom" === this._position || "top" === this._position)
                        y = v(g.options.labelWrap) ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position)
                        y = v(g.options.labelWrap) ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
        ...
        y.setLayout = function (a, d, b, c, e, g) {
            var h, k, m, l, p = a[0] ? a[0].chart : d[0].chart, q = p.isNavigator ? 0 : 10, n = p._axes;
            if (a && 0 < a.length)
            ...
            for (f = 0; f < n.length; f++)
                if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
                    for (var r = n[f].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > n[f].viewportMaximum); w++)
                        r[w].endValue < n[f].viewportMinimum || (v(n[f].scaleBreaks.firstBreakIndex) && (n[f].scaleBreaks.firstBreakIndex = w), r[w].startValue >= n[f].viewPortMinimum && (n[f].scaleBreaks.lastBreakIndex = w));
            for (var y = w = 0, s = 0, C = 0, x = 0, D = 0, z = 0, B, E, F = k = 0, H, I, L, r = H = I = L = !1, f = 0; f < n.length; f++)
                ...
                for (var C = [], x = [], D = [], z = [], M = [], N = [], O = [], Q = []; 4 > w;) {
                    ...
                    if (c && 0 < c.length)
                        for (z = [], f = ba = 0; f < c.length; f++)
                            z.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateWidth() : 0)), ba += z[f], $ += c[f] ? c[f].margin : 0;
                    else
                    ...
                    if (a && 0 < a.length)
                        for (C = [], f = V = 0; f < a.length; f++)
                            a[f] && (a[f].lineCoordinates = {}), a[f].lineCoordinates.width = Math.abs(m - h), a[f].title && (a[f]._titleTextBlock.maxWidth = 0 < a[f].titleMaxWidth && a[f].titleMaxWidth < a[f].lineCoordinates.width ? a[f].titleMaxWidth : a[f].lineCoordinates.width), C.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateHeight() : 0)), V += C[f], e += a[f] && !p.isNavigator ? a[f].margin : 0;
                    else
                    ...
                    if (d && 0 < d.length)
                        for (x =
                            [], f = X = 0; f < d.length; f++)
                            d[f] && (d[f].lineCoordinates = {}), d[f].lineCoordinates.width = Math.abs(m - h), d[f].title && (d[f]._titleTextBlock.maxWidth = 0 < d[f].titleMaxWidth && d[f].titleMaxWidth < d[f].lineCoordinates.width ? d[f].titleMaxWidth : d[f].lineCoordinates.width), x.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateHeight() : 0)), X += x[f], W += d[f] && !p.isNavigator ? d[f].margin : 0;
                    else
                        ...
                        for (f = 0; f < b.length; f++)
                            K = p.isNavigator ? 0 :
                                10, b[f] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[b[f]._labels.length - 1].textBlock.height / 2 : q, k = Math.round(g.y1 + X + W < Math.max(K, q) ? Math.max(K, q) : g.y1 + X + W), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[0].textBlock.height / 2 : q, l = Math.round(g.y2 - V - e - K), b[f].lineCoordinates = { x1: m - S, y1: k, x2: m - S, y2: l, height: Math.abs(l - k) }, b[f].bounds = { x1: h - (D[f] +
                                    S), y1: k, x2: m, y2: l, width: m - h, height: l - k }, b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.height ? b[f].titleMaxWidth : b[f].lineCoordinates.height), S += D[f] + b[f].margin);
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(h), K = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(g.y1 + X + W < Math.max(K, q) ? Math.max(K, q) : g.y1 +
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (d && 0 < d.length)
                        for (y = [], f = V = 0; f < d.length; f++)
                            y.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateWidth() : 0)), V += y[f], W += d[f] ? d[f].margin : 0;
                    else
                        y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    N.push(y);
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            b[f].lineCoordinates = {}, h = Math.round(g.x1 + U + e), m = Math.round(g.x2 - V - W > p.width - 10 ? p.width - 10 : g.x2 - V - W), b[f].labelAutoFit && !v(C) && (0 < !a.length && (h = 0 > b[f].labelAngle ? Math.max(h, C) : 0 === b[f].labelAngle ?
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f].lineCoordinates = {}, h = Math.round(g.x1 + U + e), m = Math.round(g.x2 - V - W > c[f].chart.width - 10 ? c[f].chart.width - 10 : g.x2 - V - W), c[f] &&
                    ...
                    E.push(q);
                    if (c && 0 < c.length)
                        for (B = [], f = R = 0; f < c.length; f++)
                            B.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)), R += B[f], $ += c[f].margin;
                    else
                        B.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    s.push(B);
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            0 < b[f]._labels.length && (l = b[f]._labels[0], k = b[f]._labels[b[f]._labels.length - 1], C = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) +
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f] && 0 < c[f]._labels.length && (l = c[f]._labels[0], k = c[f]._labels[c[f]._labels.length - 1], D = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI /
                    ...
                    if (b && 0 < b.length)
                        for (f = b.length - 1; 0 <= f; f--)
                            k = Math.round(g.y2), l = Math.round(g.y2 > b[f].chart.height - 10 ? b[f].chart.height - 10 : g.y2), b[f].lineCoordinates.y1 = k - (q[f] + b[f].margin +
                                X), b[f].lineCoordinates.y2 = k - (q[f] + b[f].margin + X), b[f].bounds = { x1: h, y1: k - (q[f] + X + b[f].margin), x2: m, y2: l - (X + b[f].margin), width: m - h, height: q[f] }, b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width), X += q[f] + b[f].margin;
                    if (c && 0 < c.length)
                        for (f = c.length - 1; 0 <= f; f--)
                            c[f] && (k = Math.round(g.y1), l = Math.round(g.y1 + (B[f] + c[f].margin + G)), c[f].lineCoordinates.y1 = l, c[f].lineCoordinates.y2 = l, c[f].bounds = { x1: h, y1: k +
                                    (c[f].margin + G), x2: m, y2: l, width: m - h, height: R }, c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width), G += B[f] + c[f].margin);
                    if (a && 0 < a.length)
                        for (f = 0; f < a.length; f++) {
                            ...
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (m = 0 > b[K].labelAngle ? Math.max(m, C) : 0 === b[K].labelAngle ? Math.max(m, C / 2) : m, h = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? m - U : h);
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (m = c[K].lineCoordinates.x1, h = m - U);
                            a[f].lineCoordinates =
                                { x1: m - O, y1: k, x2: m - O, y2: l, height: Math.abs(l - k) };
                            a[f].bounds = { x1: m - (F[f] + O), y1: k, x2: m, y2: l, width: m - h, height: l - k };
                    ...
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++) {
                            ...
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (m = 0 > b[K].labelAngle ? Math.max(m, C) : 0 === b[K].labelAngle ? Math.max(m, C / 2) : m, h = 0 > b[K].labelAngle || 0 ===
                                        b[K].labelAngle ? m - V : h);
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (m = c[K].lineCoordinates.x2, h = m - V);
                            d[f].lineCoordinates = { x1: m + Q, y1: k, x2: m + Q, y2: l, height: Math.abs(l - k) };
                            d[f].bounds = { x1: h, y1: k, x2: m + y[f] + Q, y2: l, width: m - h, height: l - k };
        ...
        y.render = function (a, d, b, c, e) {
            ...
            if (a && 0 < a.length)
                for (var k = 0; k < a.length; k++)
                    a[k].renderLabelsTicksAndTitle();
            if (d && 0 < d.length)
                for (k = 0; k < d.length; k++)
                    d[k].renderLabelsTicksAndTitle();
            e.restore();
            if (b && 0 < b.length)
                for (k = 0; k < b.length; k++)
                    b[k].renderLabelsTicksAndTitle();
            if (c && 0 < c.length)
                for (k =
                    0; k < c.length; k++)
                    c[k].renderLabelsTicksAndTitle();
            g.preparePlotArea();
            g = g.plotArea;
            e.save();
            e.beginPath();
            ...
            if (a && 0 < a.length)
                for (k = 0; k < h.length; k++)
                    h[k].renderStripLinesOfThicknessType("value");
            if (d && 0 < d.length)
                for (k = 0; k < d.length; k++)
                    d[k].renderStripLinesOfThicknessType("value");
            if (b && 0 < b.length)
                for (k = 0; k < b.length; k++)
                    b[k].renderStripLinesOfThicknessType("value");
            if (c && 0 < c.length)
                for (k = 0; k < c.length; k++)
                    c[k].renderStripLinesOfThicknessType("value");
            if (a && 0 < a.length)
                for (k = 0; k < a.length; k++)
                    a[k].renderInterlacedColors();
            if (d && 0 < d.length)
                for (k = 0; k < d.length; k++)
                    d[k].renderInterlacedColors();
            if (b && 0 < b.length)
                for (k = 0; k < b.length; k++)
                    b[k].renderInterlacedColors();
            if (c && 0 < c.length)
                for (k = 0; k < c.length; k++)
                    c[k].renderInterlacedColors();
            e.restore();
            if (a && 0 < a.length)
                for (k = 0; k < a.length; k++)
                    a[k].renderGrid(), r && (a[k].createMask(), a[k].renderBreaksBackground());
            if (d && 0 < d.length)
                for (k = 0; k < d.length; k++)
                    d[k].renderGrid(), r && (d[k].createMask(), d[k].renderBreaksBackground());
            if (b && 0 < b.length)
                for (k = 0; k < b.length; k++)
                    b[k].renderGrid(), r && (b[k].createMask(), b[k].renderBreaksBackground());
            if (c && 0 < c.length)
                for (k = 0; k < c.length; k++)
                    c[k].renderGrid(), r && (c[k].createMask(), c[k].renderBreaksBackground());
            if (a && 0 < a.length)
                for (k = 0; k < a.length; k++)
                    a[k].renderAxisLine();
            if (d && 0 < d.length)
            ...
            if (a && 0 < a.length)
                for (k = 0; k < a.length; k++)
                    a[k].renderStripLinesOfThicknessType("pixel");
            if (d && 0 < d.length)
                for (k = 0; k < d.length; k++)
                    d[k].renderStripLinesOfThicknessType("pixel");
            if (b && 0 < b.length)
                for (k = 0; k < b.length; k++)
                    b[k].renderStripLinesOfThicknessType("pixel");
            if (c && 0 < c.length)
                for (k = 0; k < c.length; k++)
                    c[k].renderStripLinesOfThicknessType("pixel");
        };
        ...
        y.prototype.calculateBreaksSizeInValues = function () {
            for (var a = "left" ===
                ...
                e = c || !v(d[g].options.spacing), d[g].spacing =
        ...
        y.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("undefined" ===
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        for (l = 0; l < this._labels.length; l++)
                            q = this._labels[l], q.position < this.viewportMinimum || (h = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += h);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic &&
                        ...
                        for (l =
                            0; l < this._labels.length; l++)
                            q = this._labels[l], q.position < this.viewportMinimum || (p = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += p);
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener("dataAnimationIterationEnd", function () { for (l = 0; l < a._labels.length; l++)
                    q = a._labels[l], q.position < a.viewportMinimum || (q.position > a.viewportMaximum || d && 0 !== g++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), q.textBlock.render(!0), a.ctx.restore()); }, this);
            else
                for (l = 0; l < this._labels.length; l++)
                    q = this._labels[l], q.position < this.viewportMinimum || (q.position > this.viewportMaximum || d && 0 !== g++ % 2 && this.labelAutoFit) || q.textBlock.render(!0);
        };
        ...
        y.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, b, c = 0, e = 0, g = !1, h = !1, k = [], m = [], h = !1, c = 0; c < this.stripLines.length; c++) {
                ...
                if (!h) {
                    ...
                    for (c = 0; c < k.length; c++)
                        l = k[c], l.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                            this.ctx.save();
                            this.ctx.beginPath();
                            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                            this.ctx.clip();
                            for (e = 0; e < k.length; e++)
                                l = k[e], l.showOnTop && l.render();
                            this.ctx.restore();
                        }, l)) : l.render();
                    for (c = 0; c < m.length; c++)
                        b = m[c], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { for (e = 0; e < m.length; e++)
                            b = m[e], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), b.textBlock.render(!0), d.ctx.restore()); }, b.textBlock)) :
        ...
        y.prototype.renderCrosshair = function (a, d) { this.crosshair.render(a, d); };
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !v(this.scaleBreaks.firstBreakIndex))
                        if (v(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++)
                                d.moveTo(e, h), d.lineTo(this.scaleBreaks._appliedBreaks[k].startPixel + b, h), e = this.scaleBreaks._appliedBreaks[k].endPixel + c;
                ...
                if (this.scaleBreaks && !v(this.scaleBreaks.firstBreakIndex))
                    if (v(this.scaleBreaks.lastBreakIndex))
                        ...
                        for (k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++)
                            d.moveTo(h, e), d.lineTo(h, this.scaleBreaks._appliedBreaks[k].startPixel + c),
        ...
        y.prototype.getApparentDifference = function (a, d, b, c) {
            ...
            if (this.logarithmic) {
                ...
                for (b = v(b) ? Math.abs(d - a) : b, g = 0; g < e.length && !(d < e[g].startValue); g++)
        ...
        y.prototype.setViewPortRange = function (a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d); this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, d); };
        ...
        y.prototype.calculateAxisParameters = function () {
            if (this.logarithmic)
                ...
                if (v(this.options.viewportMinimum) && !v(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum))
                ...
                if (v(this.options.viewportMaximum) && !v(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum))
        ...
        y.generateValueFormatString = function (a, d) { var b = "#,##0.", c = d; 1 > a && (c += Math.floor(Math.abs(Math.log(a) / Math.LN10)), isNaN(c) || !isFinite(c)) && (c = d); for (var e = 0; e < c; e++)
            b += "#"; return b; };
        y.getNiceExponent = function (a, d) { var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b), c = 0 > b ? 1 >= c ? 1 : 5 >= c ? 5 : 10 : Math.max(Math.floor(c), 1); return -20 > b ? Number(c * Math.pow(10, b)) : Number((c * Math.pow(10, b)).toFixed(20)); };
        y.getNiceNumber =
            ...
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (c = 1 === q % 2 ? (c.x << 0) + 0.5 : c.x << 0, h = 1 === q % 2 ? (e.x << 0) + 0.5 :
                        ...
                        this.ctx.lineTo(m, l);
                        for (n = 0; n < p; n++)
                            this.ctx.bezierCurveTo(m + g * a, l - a, m + g * a, l - 2 * a, m, l - 3 * a), l -= 3 * a, g *= -1;
                    }
                    else {
                        if ("zigzag" === this.type) {
                            g = -1;
                            ...
                            p = (k - l) / a / 2;
                            for (n = 0; n < p; n++)
                                this.ctx.lineTo(m, l), m += 2 * g * a, l += 2 * a, g *= -1;
                            this.ctx.lineTo(m, l);
                            m += h - c;
                            for (n = 0; n < p + 1; n++)
                                this.ctx.lineTo(m, l), m += 2 * g * a, l -= 2 * a, g *= -1;
                    ...
                    if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y << 0, k = 1 === q % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - q / 2, x2: h, y2: k + q / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a)
                        this.ctx.lineTo(h, e), this.ctx.lineTo(h, k),
                            this.ctx.lineTo(c, k);
                    else if ("wavy" === this.type) {
                        m = c;
                        l = e;
                        ...
                        p = (h - m) / a / 3;
                        for (n = 0; n < p; n++)
                            this.ctx.bezierCurveTo(m + a, l + g * a, m + 2 * a, l + g * a, m + 3 * a, l), m += 3 * a, g *= -1;
                        ...
                        p = (h - m) / a / 2;
                        for (n = 0; n < p; n++)
                            this.ctx.lineTo(m, l), l += 2 * g * a, m += 2 * a, g *= -1;
                        this.ctx.lineTo(m, l);
                        l += k - e;
                        for (n = 0; n < p + 1; n++)
                            this.ctx.lineTo(m, l), l += 2 * g * a, m -= 2 * a, g *= -1;
        ...
        X.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    e = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: h, x2: g + d / 2, y2: k };
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    h = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: e, y1: h - d / 2, x2: g, y2: k + d / 2 };
                this.ctx.moveTo(e, h);
                this.ctx.lineTo(g, k);
                this.ctx.stroke();
        ...
        fa.prototype.render = function (a, d) {
            var b, c, e, g, h = null, k = h = null, m = "";
            if (!this.valueFormatString)
                if ("dateTime" === this.parent.valueType)
                    this.valueFormatString = this.parent.valueFormatString;
                else {
                    var l = 0, l = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ?
            ...
            var k = null === this.opacity ? 1 : this.opacity, l = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness), p = this.chart.overlaidCanvasCtx, q = p.globalAlpha;
            p.globalAlpha = k;
            p.beginPath();
            ...
            if ("left" === this.parent._position || "right" === this.parent._position)
                this.labelMaxWidth = v(this.options.labelMaxWidth) ? this.parent.bounds.x2 - this.parent.bounds.x1 : this.labelMaxWidth, this.labelMaxHeight = v(this.options.labelWrap) || this.labelWrap ? 3 * this.chart.height : 2 * this.labelFontSize;
            else if ("top" === this.parent._position || "bottom" === this.parent._position)
                this.labelMaxWidth = v(this.options.labelMaxWidth) ? 3 * this.chart.width : this.labelMaxWidth,
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var r = 0; r <
                        ...
                        (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (f.dataSeries = this.parent.dataSeries[r], null !== f.dataPoint.y && h.push(f));
                    f = null;
                    if (0 === h.length)
                        return;
                    ...
                    if ("rangeBar" === h[0].dataSeries.type || "error" === h[0].dataSeries.type)
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(h[r].dataPoint.y[0])), w = 0, n = 0; n < h.length; n++)
                            if (h[n].dataPoint.y &&
                                ...
                                for (m = 0; m < h[n].dataPoint.y.length; m++)
                                    w = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), w < f && (f = w, r = n);
                            else
                                w = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y)), w < f && (f = w, r = n);
                        ...
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), D = w = 0, n = r = 0; n < h.length; n++)
                            if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                                for (m = 0; m < h[n].dataPoint.y.length; m++)
                                    w = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])),
                                        w < f && (f = w, r = n);
                            else
                                D += h[n].dataPoint.y, w = Math.abs(a - this.parent.convertValueToPixel(D)), w < f && (f = w, r = n);
                        ...
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), s = D = w = 0, n = 0; n < h.length; n++)
                            if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                                ...
                                D += h[n].dataPoint.y, s = h[n].dataPoint.x.getTime ? h[n].dataPoint.x.getTime() : h[n].dataPoint.x,
                    ...
                    if ("bottom" === this.parent._position ||
                        ...
                        if ("rangeBar" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type) {
                            ...
                            for (n = w = 0; n < m.dataPoint.y.length; n++)
                                w = Math.abs(a - this.parent.convertValueToPixel(m.dataPoint.y[n])), w < f && (f = w, b = n);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart,
                                axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y[b] }) : v(this.options.label) ? ba(m.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label;
                        }
                        else if ("stackedBar" === this.parent.dataSeries[r].type) {
                            f = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y));
                            D = w = 0;
                            for (n = r; 0 <= n; n--)
                                D += h[n].dataPoint.y, w = Math.abs(a - this.parent.convertValueToPixel(D)), w < f && (f = w, b = n);
                            h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(D) << 0) + 0.5 : this.parent.convertValueToPixel(D) << 0;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : v(this.options.label) ? ba(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        }
                        else if ("stackedBar100" === this.parent.dataSeries[r].type) {
                            f = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y));
                            s = D = w = 0;
                            for (n = r; 0 <= n; n--)
                                D += h[n].dataPoint.y, s = h[n].dataPoint.x.getTime ? h[n].dataPoint.x.getTime() : h[n].dataPoint.x, s = 100 * (D / h[n].dataSeries.plotUnit.dataPointYSums[s]),
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s }) : v(this.options.label) ? ba(s, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        }
                        else
                            h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y) <<
                                0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : v(this.options.label) ? ba(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = c = h;
                        e = this.chart.plotArea.y1;
                        g = this.chart.plotArea.y2;
                        this.bounds = { x1: b - l / 2, y1: e, x2: c + l / 2, y2: g };
                        ...
                        this.bounds = { x1: b, y1: e - l / 2, x2: c, y2: g + l / 2 };
                        s = !1;
                        ...
                        if (s) {
                            if ("axisX" === this.parent.type)
                                for (n =
                                    ...
                                    (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : v(this.options.label) ? f.dataPoint.label : this.label);
                        }
                        else
                            "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) :
                                v(this.options.label) ? Ca(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : v(this.options.label) ? ba(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (s) {
                        ...
                        "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options,
                            value: m.dataPoint.x }) : v(this.options.label) ? Ca(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : v(this.options.label) ? ba(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    k.x = b - k.measureText().width / 2;
                    ...
                    !v(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (n = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                    for (r = 0; r < this.parent.dataSeries.length; r++)
                    ...
                    if ("rangeColumn" === h[0].dataSeries.type || "rangeArea" === h[0].dataSeries.type || "error" === h[0].dataSeries.type || "rangeSplineArea" === h[0].dataSeries.type || "candlestick" === h[0].dataSeries.type || "ohlc" === h[0].dataSeries.type || "boxAndWhisker" === h[0].dataSeries.type)
                        for (f = Math.abs(d - this.parent.convertValueToPixel(h[0].dataPoint.y[0])), n = w = 0; n < h.length; n++)
                            if (h[n].dataPoint.y &&
                                h[n].dataPoint.y.length)
                                for (m = 0; m < h[n].dataPoint.y.length; m++)
                                    w = Math.abs(d - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), w < f && (f = w, r = n);
                            else
                                w = Math.abs(d - this.parent.convertValueToPixel(h[n].dataPoint.y)), w < f && (f = w, r = n);
                        ...
                        for (f = Math.abs(d - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = D = w = 0; n < h.length; n++)
                            if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                                for (m = 0; m < h[n].dataPoint.y.length; m++)
                                    w = Math.abs(d - this.parent.convertValueToPixel(h[n].dataPoint.y[m])),
                                        w < f && (f = w, r = n);
                            else
                                D += h[n].dataPoint.y, w = Math.abs(d - this.parent.convertValueToPixel(D)), w < f && (f = w, r = n);
                        ...
                        for (f = Math.abs(d - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = s = D = w = 0; n < h.length; n++)
                            if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                                ...
                                D += h[n].dataPoint.y, s = h[n].dataPoint.x.getTime ?
                        ...
                        for (f = Math.abs(d - this.parent.convertValueToPixel(h[0].dataPoint.y)), n = w = 0; n < h.length; n++)
                            if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                                ...
                                w = Math.abs(d - this.parent.convertValueToPixel(h[n].dataPoint.y)), w < f && (f = w, r =
                                    n);
                    m = h[r];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[r].type || "rangeArea" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type || "rangeSplineArea" === this.parent.dataSeries[r].type || "candlestick" === this.parent.dataSeries[r].type || "ohlc" === this.parent.dataSeries[r].type || "boxAndWhisker" === this.parent.dataSeries[r].type) {
                        ...
                        for (n = w = 0; n < m.dataPoint.y.length; n++)
                            w = Math.abs(d - this.parent.convertValueToPixel(m.dataPoint.y[n])),
                                w < f && (f = w, b = n);
                        h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y[b] }) : v(this.options.label) ? ba(m.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label;
                    }
                        ...
                        D = w = 0;
                        for (n = r; 0 <= n; n--)
                            D += h[n].dataPoint.y, w = Math.abs(d - this.parent.convertValueToPixel(D)), w < f && (f = w, b = n);
                        h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(D) << 0) + 0.5 : this.parent.convertValueToPixel(D) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : v(this.options.label) ? ba(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                    }
                        ...
                        D = w = 0;
                        for (n = r; 0 <= n; n--)
                            D += h[n].dataPoint.y, s = h[n].dataPoint.x.getTime ? h[n].dataPoint.x.getTime() : h[n].dataPoint.x, s = 100 * (D / h[n].dataSeries.plotUnit.dataPointYSums[s]), w = Math.abs(d - this.parent.convertValueToPixel(s)), w < f && (f = w, b = n);
                        h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(s) << 0) + 0.5 : this.parent.convertValueToPixel(s) << 0;
                        k.text = this.labelFormatter ?
                            this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s }) : v(this.options.label) ? ba(s, this.valueFormatString, this.chart._cultureInfo) : this.label;
                    }
                    else
                        "waterfall" === this.parent.dataSeries[r].type ? (h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options,
                            crosshair: this.options, value: m.dataSeries.dataPointEOs[m.index].cumulativeSum }) : v(this.options.label) ? ba(m.dataSeries.dataPointEOs[m.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label) : (h = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : v(this.options.label) ? ba(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    e = g = h;
                    b = this.chart.plotArea.x1;
                    c = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: e - l / 2, x2: c, y2: g + l / 2 };
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    b = c = h = 1 === p.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, e = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = { x1: b - l / 2, y1: e, x2: c + l / 2, y2: g };
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    e = g = h = 1 === p.lineWidth %
                        2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, c = this.chart.plotArea.x2, this.bounds = { x1: b, y1: e - l / 2, x2: c, y2: g + l / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        s = !1;
                        if (this.parent.labels)
                        ...
                        if (s) {
                            if ("axisX" === this.parent.type)
                                for (n = this.parent.convertPixelToValue({ y: d }), f = null, r = 0; r < this.parent.dataSeries.length; r++)
                                    (f =
                                        this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) }) : v(this.options.label) ? f.dataPoint.label : this.label);
                        }
                        else
                            "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(d) }) : v(this.options.label) ? Ca(this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(d) }) : v(this.options.label) ? ba(this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) }) : v(this.options.label) ?
                    ...
                    if (s) {
                        if ("axisX" === this.parent.type)
                            for (n = this.parent.convertPixelToValue({ x: a }), f = null, r = 0; r < this.parent.dataSeries.length; r++)
                                (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) }) :
                                    v(this.options.label) ? f.dataPoint.label : this.label);
                    }
                    else
                        "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) }) : v(this.options.label) ? Ca(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options,
                            value: 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" }) : v(this.options.label) ? ba(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    k.x = b - k.measureText().width / 2;
                    k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
                    ...
                    k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(d) }) : v(this.options.label) ? ba(this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height -
        ...
        $.prototype._updateToolTip = function (a, d, b) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" ===
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var h = this.chart.axisX[m].convertPixelToValue({ y: d }), l = null, c = 0; c < this.chart.axisX[m].dataSeries.length; c++)
                                    (l = this.chart.axisX[m].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[m].dataSeries[c], null !== l.dataPoint.y && k.push(l));
                                l = null;
                            }
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++) {
                                h = this.chart.axisX2[m].convertPixelToValue({ y: d });
                                l = null;
                                for (c =
                                    0; c < this.chart.axisX2[m].dataSeries.length; c++)
                                    (l = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[m].dataSeries[c], null !== l.dataPoint.y && k.push(l));
                                l = null;
                            }
                    }
                    else {
                        ...
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (h = this.chart.axisX[m].convertPixelToValue({ x: a }), l = null, c = 0; c < this.chart.axisX[m].dataSeries.length; c++)
                                    (l = this.chart.axisX[m].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[m].dataSeries[c],
                                        null !== l.dataPoint.y && k.push(l));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (h = this.chart.axisX2[m].convertPixelToValue({ x: a }), l = null, c = 0; c < this.chart.axisX2[m].dataSeries.length; c++)
                                    (l = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[m].dataSeries[c], null !== l.dataPoint.y && k.push(l));
                    }
                    if (0 === k.length)
                        return;
                    ...
                    b = k[0];
                    for (c = 0; c < k.length; c++)
                        k[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() &&
                            g.push(k[c]);
                    k = null;
                }
                else {
                    if (l = this.chart.getDataPointAtXY(a, d, b))
                        this.currentDataPointIndex = l.dataPointIndex, this.currentSeriesIndex = l.dataSeries.index;
                    else if (r)
                        ...
                        if (!v(l) && !v(l.dataPoint) && !v(l.dataPoint.y))
                            if (l.dataSeries.axisY)
                                if (0 < l.dataPoint.y.length) {
                                    for (c = b = 0; c < l.dataPoint.y.length; c++)
                                        l.dataPoint.y[c] <
                                    ...
                                    "column" === e.type || "bar" === e.type ? 0 > l.dataPoint.y ? 0 > l.dataSeries.axisY.viewportMinimum && l.dataSeries.axisY.viewportMaximum >= l.dataPoint.y && g.push(l) : l.dataSeries.axisY.viewportMinimum <= l.dataPoint.y && 0 <= l.dataSeries.axisY.viewportMaximum && g.push(l) : "bubble" === e.type ? (b = this.chart._eventManager.objectMap[e.dataPointIds[l.index]].size / 2, l.dataPoint.y >=
        ...
        $.prototype.getToolTipInnerHTML = function (a) {
            ...
            if (h && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var m = null, l = "", k = 0; k < a.length; k++)
                    b = a[k].dataSeries, c = a[k].dataPoint, e = a[k].index, g = "", 0 === k && (h && !this.content) && (this.chart.axisX &&
        ...
        var M = { yScaleAnimation: function (a, d) { if (0 !== a) {
                ...
                b.restore();
            } }, easing: { linear: function (a, d, b, c) { return b * a / c + d; }, easeOutQuad: function (a, d, b, c) { return -b * (a /= c) * (a - 2) + d; }, easeOutQuart: function (a, d, b, c) { return -b * ((a = a / c - 1) * a * a * a - 1) + d; }, easeInQuad: function (a, d, b, c) { return b * (a /= c) * a + d; }, easeInQuart: function (a, d, b, c) { return b * (a /= c) * a * a * a + d; } } }, ia = { drawMarker: function (a, d, b, c, e, g, h, k) {
                if (b) {
                    var m = 1;

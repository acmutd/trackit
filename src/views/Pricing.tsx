        ...
        <Container fluid>
          <div className="m-5 p-5 floating-icon">
            ...
            <p className="mt-3 ml-5 mr-5">
              ...
              suits them well. Contact{" "}
              <strong>
                <a href="mailto:development@acmutd.co">ACM Development</a>
              </strong>{" "}
              to learn more about how you can integrate TrackIT into your
              workshop. We offer special partnership and collaboration options
              for student organizations and non-profits. If you believe that
              your team qualifies please feel free to reach out and work with
              us.
            </p>
            <br />

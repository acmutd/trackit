...
class UserDash extends React.Component {
  ...
  render() {
    let workshop_levels = this.state.workshop_data.Level_Descriptions.map(
      function (item, index) {
    ...
    let workshop_level_text = this.state.workshop_data.level_text[
      this.state.currentPage
    ];
    let workshop_level_title = this.state.workshop_data.Level_Descriptions[
      this.state.currentPage
    ];
        ...
        <Container fluid className="text-center p-3">
          ...
          <ProgressBar className="mb-4">
            ...
            <ProgressBar
              ...
              animated
              now={
                ((this.state.adminProgress - this.state.userProgress) * 100) /
                this.state.workshop_data.Number_Of_Levels
              }
              key={2}
            />
